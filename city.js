...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b734';
import { sb } from './db.js?v=b734';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b734';
import { myRates, cityStat, visited } from './rate.js?v=b734';
import { starHtml, starValue, starsRo } from './stars.js?v=b734';
import { localTime } from './calc.js?v=b734';
