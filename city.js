...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b695';
import { sb } from './db.js?v=b695';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b695';
import { myRates, cityStat, visited } from './rate.js?v=b695';
import { starHtml, starValue } from './stars.js?v=b695';
import { localTime } from './calc.js?v=b695';
