...
import { $, esc, avatarImg, emptyDo } from './dom.js?v=b549';
import { sb } from './db.js?v=b549';
import { cities, countryName, continentOf } from './cities.js?v=b549';
import { myRates, cityStat, visited } from './rate.js?v=b549';
import { starHtml, starValue } from './stars.js?v=b549';
import { localTime } from './calc.js?v=b549';
