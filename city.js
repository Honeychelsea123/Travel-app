...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b675';
import { sb } from './db.js?v=b675';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b675';
import { myRates, cityStat, visited } from './rate.js?v=b675';
import { starHtml, starValue } from './stars.js?v=b675';
import { localTime } from './calc.js?v=b675';
