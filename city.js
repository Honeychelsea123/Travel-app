...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b738';
import { sb } from './db.js?v=b738';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b738';
import { myRates, cityStat, visited } from './rate.js?v=b738';
import { starHtml, starValue, starsRo } from './stars.js?v=b738';
import { localTime } from './calc.js?v=b738';
