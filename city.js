...
import { $, esc, avatarImg, emptyDo } from './dom.js?v=b534';
import { sb } from './db.js?v=b534';
import { cities, countryName, continentOf } from './cities.js?v=b534';
import { myRates, cityStat, visited } from './rate.js?v=b534';
import { starHtml, starValue } from './stars.js?v=b534';
import { localTime, dateRange, hm } from './calc.js?v=b534';
