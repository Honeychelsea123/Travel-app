...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b680';
import { sb } from './db.js?v=b680';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b680';
import { myRates, cityStat, visited } from './rate.js?v=b680';
import { starHtml, starValue } from './stars.js?v=b680';
import { localTime } from './calc.js?v=b680';
