...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b678';
import { sb } from './db.js?v=b678';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b678';
import { myRates, cityStat, visited } from './rate.js?v=b678';
import { starHtml, starValue } from './stars.js?v=b678';
import { localTime } from './calc.js?v=b678';
