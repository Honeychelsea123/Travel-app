...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b700';
import { sb } from './db.js?v=b700';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b700';
import { myRates, cityStat, visited } from './rate.js?v=b700';
import { starHtml, starValue } from './stars.js?v=b700';
import { localTime } from './calc.js?v=b700';
