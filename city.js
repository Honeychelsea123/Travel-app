...
import { $, esc, avatarImg, emptyDo } from './dom.js?v=b548';
import { sb } from './db.js?v=b548';
import { cities, countryName, continentOf } from './cities.js?v=b548';
import { myRates, cityStat, visited } from './rate.js?v=b548';
import { starHtml, starValue } from './stars.js?v=b548';
import { localTime } from './calc.js?v=b548';
