...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b748';
import { sb } from './db.js?v=b748';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b748';
import { myRates, cityStat, visited } from './rate.js?v=b748';
import { starHtml, starValue, starsRo } from './stars.js?v=b748';
import { localTime } from './calc.js?v=b748';
