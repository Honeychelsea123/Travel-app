...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b720';
import { sb } from './db.js?v=b720';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b720';
import { myRates, cityStat, visited } from './rate.js?v=b720';
import { starHtml, starValue } from './stars.js?v=b720';
import { localTime } from './calc.js?v=b720';
