...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b676';
import { sb } from './db.js?v=b676';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b676';
import { myRates, cityStat, visited } from './rate.js?v=b676';
import { starHtml, starValue } from './stars.js?v=b676';
import { localTime } from './calc.js?v=b676';
