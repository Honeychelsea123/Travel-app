...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b709';
import { sb } from './db.js?v=b709';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b709';
import { myRates, cityStat, visited } from './rate.js?v=b709';
import { starHtml, starValue } from './stars.js?v=b709';
import { localTime } from './calc.js?v=b709';
