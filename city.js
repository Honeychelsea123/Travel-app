...
import { $, esc, avatarImg, emptyDo } from './dom.js?v=b526';
import { sb } from './db.js?v=b526';
import { cities, countryName, continentOf } from './cities.js?v=b526';
import { myRates, cityStat, visited } from './rate.js?v=b526';
import { starHtml, starValue } from './stars.js?v=b526';
import { localTime, dateRange, hm } from './calc.js?v=b526';
