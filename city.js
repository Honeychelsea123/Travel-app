...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b744';
import { sb } from './db.js?v=b744';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b744';
import { myRates, cityStat, visited } from './rate.js?v=b744';
import { starHtml, starValue, starsRo } from './stars.js?v=b744';
import { localTime } from './calc.js?v=b744';
