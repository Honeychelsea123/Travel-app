...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b704';
import { sb } from './db.js?v=b704';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b704';
import { myRates, cityStat, visited } from './rate.js?v=b704';
import { starHtml, starValue } from './stars.js?v=b704';
import { localTime } from './calc.js?v=b704';
