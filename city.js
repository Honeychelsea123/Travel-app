...
import { $, esc, avatarImg, emptyDo } from './dom.js?v=b502';
import { sb } from './db.js?v=b502';
import { cities, countryName, continentOf } from './cities.js?v=b502';
import { myRates, cityStat, visited } from './rate.js?v=b502';
import { starHtml, starValue } from './stars.js?v=b502';
import { localTime, dateRange, hm } from './calc.js?v=b502';
