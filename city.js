...
import { $, esc, avatarImg, emptyDo } from './dom.js?v=b525';
import { sb } from './db.js?v=b525';
import { cities, countryName, continentOf } from './cities.js?v=b525';
import { myRates, cityStat, visited } from './rate.js?v=b525';
import { starHtml, starValue } from './stars.js?v=b525';
import { localTime, dateRange, hm } from './calc.js?v=b525';
