...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b745';
import { sb } from './db.js?v=b745';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b745';
import { myRates, cityStat, visited } from './rate.js?v=b745';
import { starHtml, starValue, starsRo } from './stars.js?v=b745';
import { localTime } from './calc.js?v=b745';
