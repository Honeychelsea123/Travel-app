...
import { $, esc } from './dom.js?v=b332';
import { sb } from './db.js?v=b332';
import { cities, countryName, continentOf } from './cities.js?v=b332';
import { myRates, cityStat, visited } from './rate.js?v=b332';
import { starHtml } from './stars.js?v=b332';
import { localTime } from './calc.js?v=b332';
