...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b674';
import { sb } from './db.js?v=b674';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b674';
import { myRates, cityStat, visited } from './rate.js?v=b674';
import { starHtml, starValue } from './stars.js?v=b674';
import { localTime } from './calc.js?v=b674';
