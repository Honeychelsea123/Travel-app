...
import { $, esc, avatarImg, emptyDo } from './dom.js?v=b538';
import { sb } from './db.js?v=b538';
import { cities, countryName, continentOf } from './cities.js?v=b538';
import { myRates, cityStat, visited } from './rate.js?v=b538';
import { starHtml, starValue } from './stars.js?v=b538';
import { localTime } from './calc.js?v=b538';
