...
import { $, esc, avatarImg, emptyDo } from './dom.js?v=b524';
import { sb } from './db.js?v=b524';
import { cities, countryName, continentOf } from './cities.js?v=b524';
import { myRates, cityStat, visited } from './rate.js?v=b524';
import { starHtml, starValue } from './stars.js?v=b524';
import { localTime, dateRange, hm } from './calc.js?v=b524';
