...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b727';
import { sb } from './db.js?v=b727';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b727';
import { myRates, cityStat, visited } from './rate.js?v=b727';
import { starHtml, starValue } from './stars.js?v=b727';
import { localTime } from './calc.js?v=b727';
