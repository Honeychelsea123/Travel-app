...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b737';
import { sb } from './db.js?v=b737';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b737';
import { myRates, cityStat, visited } from './rate.js?v=b737';
import { starHtml, starValue, starsRo } from './stars.js?v=b737';
import { localTime } from './calc.js?v=b737';
