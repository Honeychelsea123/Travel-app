...
import { $, esc, avatarImg, emptyDo } from './dom.js?v=b500';
import { sb } from './db.js?v=b500';
import { cities, countryName, continentOf } from './cities.js?v=b500';
import { myRates, cityStat, visited } from './rate.js?v=b500';
import { starHtml, starValue } from './stars.js?v=b500';
import { localTime, dateRange, hm } from './calc.js?v=b500';
import { fail } from './net.js?v=b500';
