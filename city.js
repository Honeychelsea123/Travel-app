...
import { $, esc } from './dom.js?v=b333';
import { sb } from './db.js?v=b333';
import { cities, countryName, continentOf } from './cities.js?v=b333';
import { myRates, cityStat, visited } from './rate.js?v=b333';
import { starHtml } from './stars.js?v=b333';
import { localTime } from './calc.js?v=b333';
