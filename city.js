...
import { $, esc, avatarImg, emptyDo } from './dom.js?v=b533';
import { sb } from './db.js?v=b533';
import { cities, countryName, continentOf } from './cities.js?v=b533';
import { myRates, cityStat, visited } from './rate.js?v=b533';
import { starHtml, starValue } from './stars.js?v=b533';
import { localTime, dateRange, hm } from './calc.js?v=b533';
