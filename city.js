...
import { $, esc, avatarImg, emptyDo } from './dom.js?v=b508';
import { sb } from './db.js?v=b508';
import { cities, countryName, continentOf } from './cities.js?v=b508';
import { myRates, cityStat, visited } from './rate.js?v=b508';
import { starHtml, starValue } from './stars.js?v=b508';
import { localTime, dateRange, hm } from './calc.js?v=b508';
