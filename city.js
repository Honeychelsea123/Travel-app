...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b714';
import { sb } from './db.js?v=b714';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b714';
import { myRates, cityStat, visited } from './rate.js?v=b714';
import { starHtml, starValue } from './stars.js?v=b714';
import { localTime } from './calc.js?v=b714';
