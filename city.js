...
import { $, esc, avatarImg, emptyDo } from './dom.js?v=b514';
import { sb } from './db.js?v=b514';
import { cities, countryName, continentOf } from './cities.js?v=b514';
import { myRates, cityStat, visited } from './rate.js?v=b514';
import { starHtml, starValue } from './stars.js?v=b514';
import { localTime, dateRange, hm } from './calc.js?v=b514';
