...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b685';
import { sb } from './db.js?v=b685';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b685';
import { myRates, cityStat, visited } from './rate.js?v=b685';
import { starHtml, starValue } from './stars.js?v=b685';
import { localTime } from './calc.js?v=b685';
