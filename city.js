...
import { $, esc, avatarImg, emptyDo } from './dom.js?v=b497';
import { sb } from './db.js?v=b497';
import { cities, countryName, continentOf } from './cities.js?v=b497';
import { myRates, cityStat, visited } from './rate.js?v=b497';
import { starHtml, starValue } from './stars.js?v=b497';
import { localTime, dateRange, hm } from './calc.js?v=b497';
