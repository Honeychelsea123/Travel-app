...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b684';
import { sb } from './db.js?v=b684';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b684';
import { myRates, cityStat, visited } from './rate.js?v=b684';
import { starHtml, starValue } from './stars.js?v=b684';
import { localTime } from './calc.js?v=b684';
