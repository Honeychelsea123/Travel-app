...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b742';
import { sb } from './db.js?v=b742';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b742';
import { myRates, cityStat, visited } from './rate.js?v=b742';
import { starHtml, starValue, starsRo } from './stars.js?v=b742';
import { localTime } from './calc.js?v=b742';
