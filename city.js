...
import { $, esc, avatarImg, emptyDo } from './dom.js?v=b543';
import { sb } from './db.js?v=b543';
import { cities, countryName, continentOf } from './cities.js?v=b543';
import { myRates, cityStat, visited } from './rate.js?v=b543';
import { starHtml, starValue } from './stars.js?v=b543';
import { localTime } from './calc.js?v=b543';
