...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b699';
import { sb } from './db.js?v=b699';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b699';
import { myRates, cityStat, visited } from './rate.js?v=b699';
import { starHtml, starValue } from './stars.js?v=b699';
import { localTime } from './calc.js?v=b699';
