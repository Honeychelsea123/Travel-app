...
import { $, esc, avatarImg, emptyDo } from './dom.js?v=b544';
import { sb } from './db.js?v=b544';
import { cities, countryName, continentOf } from './cities.js?v=b544';
import { myRates, cityStat, visited } from './rate.js?v=b544';
import { starHtml, starValue } from './stars.js?v=b544';
import { localTime } from './calc.js?v=b544';
