...
import { $, esc, avatarImg, emptyDo } from './dom.js?v=b530';
import { sb } from './db.js?v=b530';
import { cities, countryName, continentOf } from './cities.js?v=b530';
import { myRates, cityStat, visited } from './rate.js?v=b530';
import { starHtml, starValue } from './stars.js?v=b530';
import { localTime, dateRange, hm } from './calc.js?v=b530';
