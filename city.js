...
import { $, esc, avatarImg, emptyDo } from './dom.js?v=b523';
import { sb } from './db.js?v=b523';
import { cities, countryName, continentOf } from './cities.js?v=b523';
import { myRates, cityStat, visited } from './rate.js?v=b523';
import { starHtml, starValue } from './stars.js?v=b523';
import { localTime, dateRange, hm } from './calc.js?v=b523';
