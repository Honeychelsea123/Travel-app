...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b729';
import { sb } from './db.js?v=b729';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b729';
import { myRates, cityStat, visited } from './rate.js?v=b729';
import { starHtml, starValue } from './stars.js?v=b729';
import { localTime } from './calc.js?v=b729';
