...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b710';
import { sb } from './db.js?v=b710';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b710';
import { myRates, cityStat, visited } from './rate.js?v=b710';
import { starHtml, starValue } from './stars.js?v=b710';
import { localTime } from './calc.js?v=b710';
