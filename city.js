...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b751';
import { sb } from './db.js?v=b751';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b751';
import { myRates, cityStat, visited } from './rate.js?v=b751';
import { starHtml, starValue, starsRo } from './stars.js?v=b751';
import { localTime } from './calc.js?v=b751';
