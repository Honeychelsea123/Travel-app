...
import { $, esc, avatarImg, emptyDo } from './dom.js?v=b539';
import { sb } from './db.js?v=b539';
import { cities, countryName, continentOf } from './cities.js?v=b539';
import { myRates, cityStat, visited } from './rate.js?v=b539';
import { starHtml, starValue } from './stars.js?v=b539';
import { localTime } from './calc.js?v=b539';
