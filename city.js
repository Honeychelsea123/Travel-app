...
import { $, esc, avatarImg, emptyDo } from './dom.js?v=b545';
import { sb } from './db.js?v=b545';
import { cities, countryName, continentOf } from './cities.js?v=b545';
import { myRates, cityStat, visited } from './rate.js?v=b545';
import { starHtml, starValue } from './stars.js?v=b545';
import { localTime } from './calc.js?v=b545';
