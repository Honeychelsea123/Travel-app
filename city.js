...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b708';
import { sb } from './db.js?v=b708';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b708';
import { myRates, cityStat, visited } from './rate.js?v=b708';
import { starHtml, starValue } from './stars.js?v=b708';
import { localTime } from './calc.js?v=b708';
