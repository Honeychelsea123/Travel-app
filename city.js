...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b736';
import { sb } from './db.js?v=b736';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b736';
import { myRates, cityStat, visited } from './rate.js?v=b736';
import { starHtml, starValue, starsRo } from './stars.js?v=b736';
import { localTime } from './calc.js?v=b736';
