...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b696';
import { sb } from './db.js?v=b696';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b696';
import { myRates, cityStat, visited } from './rate.js?v=b696';
import { starHtml, starValue } from './stars.js?v=b696';
import { localTime } from './calc.js?v=b696';
