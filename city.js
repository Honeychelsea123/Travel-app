...
import { $, esc, avatarImg, emptyDo } from './dom.js?v=b528';
import { sb } from './db.js?v=b528';
import { cities, countryName, continentOf } from './cities.js?v=b528';
import { myRates, cityStat, visited } from './rate.js?v=b528';
import { starHtml, starValue } from './stars.js?v=b528';
import { localTime, dateRange, hm } from './calc.js?v=b528';
