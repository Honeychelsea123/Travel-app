...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b679';
import { sb } from './db.js?v=b679';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b679';
import { myRates, cityStat, visited } from './rate.js?v=b679';
import { starHtml, starValue } from './stars.js?v=b679';
import { localTime } from './calc.js?v=b679';
