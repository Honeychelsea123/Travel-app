...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b718';
import { sb } from './db.js?v=b718';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b718';
import { myRates, cityStat, visited } from './rate.js?v=b718';
import { starHtml, starValue } from './stars.js?v=b718';
import { localTime } from './calc.js?v=b718';
