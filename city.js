...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b673';
import { sb } from './db.js?v=b673';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b673';
import { myRates, cityStat, visited } from './rate.js?v=b673';
import { starHtml, starValue } from './stars.js?v=b673';
import { localTime } from './calc.js?v=b673';
