...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b750';
import { sb } from './db.js?v=b750';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b750';
import { myRates, cityStat, visited } from './rate.js?v=b750';
import { starHtml, starValue, starsRo } from './stars.js?v=b750';
import { localTime } from './calc.js?v=b750';
