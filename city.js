...
import { $, esc, avatarImg, emptyDo } from './dom.js?v=b527';
import { sb } from './db.js?v=b527';
import { cities, countryName, continentOf } from './cities.js?v=b527';
import { myRates, cityStat, visited } from './rate.js?v=b527';
import { starHtml, starValue } from './stars.js?v=b527';
import { localTime, dateRange, hm } from './calc.js?v=b527';
