...
import { $, esc, avatarImg, emptyDo } from './dom.js?v=b499';
import { sb } from './db.js?v=b499';
import { cities, countryName, continentOf } from './cities.js?v=b499';
import { myRates, cityStat, visited } from './rate.js?v=b499';
import { starHtml, starValue } from './stars.js?v=b499';
import { localTime, dateRange, hm } from './calc.js?v=b499';
