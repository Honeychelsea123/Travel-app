...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b717';
import { sb } from './db.js?v=b717';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b717';
import { myRates, cityStat, visited } from './rate.js?v=b717';
import { starHtml, starValue } from './stars.js?v=b717';
import { localTime } from './calc.js?v=b717';
