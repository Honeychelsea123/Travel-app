...
import { $, esc, avatarImg, emptyDo } from './dom.js?v=b495';
import { sb } from './db.js?v=b495';
import { cities, countryName, continentOf } from './cities.js?v=b495';
import { myRates, cityStat, visited } from './rate.js?v=b495';
import { starHtml, starValue } from './stars.js?v=b495';
import { localTime, dateRange, hm } from './calc.js?v=b495';
