...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b712';
import { sb } from './db.js?v=b712';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b712';
import { myRates, cityStat, visited } from './rate.js?v=b712';
import { starHtml, starValue } from './stars.js?v=b712';
import { localTime } from './calc.js?v=b712';
