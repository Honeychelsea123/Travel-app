...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b719';
import { sb } from './db.js?v=b719';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b719';
import { myRates, cityStat, visited } from './rate.js?v=b719';
import { starHtml, starValue } from './stars.js?v=b719';
import { localTime } from './calc.js?v=b719';
