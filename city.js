...
import { $, esc, avatarImg, emptyDo } from './dom.js?v=b532';
import { sb } from './db.js?v=b532';
import { cities, countryName, continentOf } from './cities.js?v=b532';
import { myRates, cityStat, visited } from './rate.js?v=b532';
import { starHtml, starValue } from './stars.js?v=b532';
import { localTime, dateRange, hm } from './calc.js?v=b532';
