...
import { $, esc, avatarImg, emptyDo } from './dom.js?v=b515';
import { sb } from './db.js?v=b515';
import { cities, countryName, continentOf } from './cities.js?v=b515';
import { myRates, cityStat, visited } from './rate.js?v=b515';
import { starHtml, starValue } from './stars.js?v=b515';
import { localTime, dateRange, hm } from './calc.js?v=b515';
