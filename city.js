...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b749';
import { sb } from './db.js?v=b749';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b749';
import { myRates, cityStat, visited } from './rate.js?v=b749';
import { starHtml, starValue, starsRo } from './stars.js?v=b749';
import { localTime } from './calc.js?v=b749';
