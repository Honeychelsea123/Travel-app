...
import { $, esc, avatarImg, emptyDo } from './dom.js?v=b540';
import { sb } from './db.js?v=b540';
import { cities, countryName, continentOf } from './cities.js?v=b540';
import { myRates, cityStat, visited } from './rate.js?v=b540';
import { starHtml, starValue } from './stars.js?v=b540';
import { localTime } from './calc.js?v=b540';
