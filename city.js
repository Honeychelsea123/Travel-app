...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b747';
import { sb } from './db.js?v=b747';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b747';
import { myRates, cityStat, visited } from './rate.js?v=b747';
import { starHtml, starValue, starsRo } from './stars.js?v=b747';
import { localTime } from './calc.js?v=b747';
