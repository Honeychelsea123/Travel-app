...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b677';
import { sb } from './db.js?v=b677';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b677';
import { myRates, cityStat, visited } from './rate.js?v=b677';
import { starHtml, starValue } from './stars.js?v=b677';
import { localTime } from './calc.js?v=b677';
