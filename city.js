...
import { $, esc, avatarImg, emptyDo, fitImage, toast } from './dom.js?v=b713';
import { sb } from './db.js?v=b713';
import { cities, countryName, countryInfo, continentOf, cityCountry } from './cities.js?v=b713';
import { myRates, cityStat, visited } from './rate.js?v=b713';
import { starHtml, starValue } from './stars.js?v=b713';
import { localTime } from './calc.js?v=b713';
