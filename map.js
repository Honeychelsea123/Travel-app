...
import { $, esc, toast, flagOf, flagOk, emptyDo, backLabel, toTop,
         coverDeck } from './dom.js?v=b667';
import { openCity } from './city.js?v=b667';
import { distKm } from './calc.js?v=b667';
import { sb } from './db.js?v=b667';
import { cities, countryName, continentOf } from './cities.js?v=b667';
...
import { shareCard } from './card.js?v=b667';
