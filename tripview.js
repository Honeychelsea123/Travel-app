...
import { photosOpen, closePhotos } from './photoview.js?v=b735';
import { sb } from './db.js?v=b735';
import { fail, netTimeout, drawOffbar, NOROW } from './net.js?v=b735';
import { D1, asDate, ymd, dayLabel } from './calc.js?v=b735';
import { trip, plans, legs, pickedDay, catFilter,
         setPickedDay, setPlans, setCatFilter, clearTrip } from './trip.js?v=b735';
import { drawCats, catsOpen, setCatsOpen } from './planline.js?v=b735';
import { drawPlanMap } from './planmap.js?v=b735';
import { drawPlans } from './planview.js?v=b735';
import { legIn, fillCityList } from './legs.js?v=b735';
import { inTrip } from './tabs.js?v=b735';
import { closeAi } from './aiscreen.js?v=b735';
import { closeDraft } from './draft.js?v=b735';
import { closeReview } from './home.js?v=b735';
/* 연속 평가(b409). 기록 탭을 통째로 덮으므로 뒤로가기가 여기를 먼저 닫습니다. */
import { closeSpree } from './spree.js?v=b735';
import { closeCity, isCityOpen } from './city.js?v=b735';
import { closeMap, closeCountries } from './map.js?v=b735';
import { closePersona } from './persona.js?v=b735';
/* 지구본 나라 카드(b555). 뒤로가기 사슬이 이것부터 닫습니다. */
import { 시트닫기 } from './home.js?v=b735';
import { closeShelf, 거르개닫기 } from './shelf.js?v=b735';
import { 나라거르개닫기 } from './rating.js?v=b735';
import { closeDiary } from './diary.js?v=b735';
import { closeDocs } from './prep.js?v=b735';
