...
import { $, esc, toast } from './dom.js?v=b474';
import { sb } from './db.js?v=b474';
import { fail, netTimeout, drawOffbar, NOROW } from './net.js?v=b474';
import { D1, asDate, ymd, dayLabel } from './calc.js?v=b474';
import { trip, plans, legs, pickedDay, catFilter,
         setPickedDay, setPlans, setCatFilter, clearTrip } from './trip.js?v=b474';
import { drawCats, catsOpen, setCatsOpen } from './planline.js?v=b474';
import { drawPlanMap } from './planmap.js?v=b474';
import { drawPlans } from './planview.js?v=b474';
import { legIn, fillCityList } from './legs.js?v=b474';
import { inTrip } from './tabs.js?v=b474';
import { closeAi } from './aiscreen.js?v=b474';
import { closeDraft } from './draft.js?v=b474';
import { closeReview } from './home.js?v=b474';
/* 연속 평가(b409). 기록 탭을 통째로 덮으므로 뒤로가기가 여기를 먼저 닫습니다. */
import { closeSpree } from './spree.js?v=b474';
import { closeCity, isCityOpen } from './city.js?v=b474';
import { closeMap, closeCountries } from './map.js?v=b474';
import { closePersona } from './persona.js?v=b474';
import { closeShelf } from './shelf.js?v=b474';
import { closeDocs } from './prep.js?v=b474';
