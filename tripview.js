...
import { fail, netTimeout, drawOffbar, NOROW } from './net.js?v=b503';
import { D1, asDate, ymd, dayLabel } from './calc.js?v=b503';
import { trip, plans, legs, pickedDay, catFilter,
         setPickedDay, setPlans, setCatFilter, clearTrip } from './trip.js?v=b503';
import { drawCats, catsOpen, setCatsOpen } from './planline.js?v=b503';
import { drawPlanMap } from './planmap.js?v=b503';
import { drawPlans } from './planview.js?v=b503';
import { legIn, fillCityList } from './legs.js?v=b503';
import { inTrip } from './tabs.js?v=b503';
import { closeAi } from './aiscreen.js?v=b503';
import { closeDraft } from './draft.js?v=b503';
import { closeReview } from './home.js?v=b503';
/* 연속 평가(b409). 기록 탭을 통째로 덮으므로 뒤로가기가 여기를 먼저 닫습니다. */
import { closeSpree } from './spree.js?v=b503';
import { closeCity, isCityOpen } from './city.js?v=b503';
import { closeMap, closeCountries } from './map.js?v=b503';
import { closePersona } from './persona.js?v=b503';
import { closeShelf } from './shelf.js?v=b503';
import { closeDocs } from './prep.js?v=b503';
