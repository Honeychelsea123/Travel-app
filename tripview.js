...
import { $, esc, toast } from './dom.js?v=b684';
import { photosOpen, closePhotos } from './photoview.js?v=b684';
import { sb } from './db.js?v=b684';
import { fail, netTimeout, drawOffbar, NOROW } from './net.js?v=b684';
import { D1, asDate, ymd, dayLabel } from './calc.js?v=b684';
import { trip, plans, legs, pickedDay, catFilter,
         setPickedDay, setPlans, setCatFilter, clearTrip } from './trip.js?v=b684';
import { drawCats, catsOpen, setCatsOpen } from './planline.js?v=b684';
import { drawPlanMap } from './planmap.js?v=b684';
import { drawPlans } from './planview.js?v=b684';
import { legIn, fillCityList } from './legs.js?v=b684';
import { inTrip } from './tabs.js?v=b684';
import { closeAi } from './aiscreen.js?v=b684';
import { closeDraft } from './draft.js?v=b684';
import { closeReview } from './home.js?v=b684';
/* 연속 평가(b409). 기록 탭을 통째로 덮으므로 뒤로가기가 여기를 먼저 닫습니다. */
import { closeSpree } from './spree.js?v=b684';
import { closeCity, isCityOpen } from './city.js?v=b684';
import { closeMap, closeCountries } from './map.js?v=b684';
import { closePersona } from './persona.js?v=b684';
/* 지구본 나라 카드(b555). 뒤로가기 사슬이 이것부터 닫습니다. */
import { 시트닫기 } from './home.js?v=b684';
import { closeShelf, 거르개닫기 } from './shelf.js?v=b684';
import { 나라거르개닫기 } from './rating.js?v=b684';
import { closeDiary } from './diary.js?v=b684';
import { closeCountryMap } from './ctrymap.js?v=b684';
import { closeDocs } from './prep.js?v=b684';
...
window.addEventListener('popstate', () => {
  ...
  /* 나라 지도(b682). 기록 탭의 지구본에서 열립니다 — 카드 시트(#gsheet)가
     이 «위»에 얹히므로 그것보다 아래, 나머지 판들과 같은 층입니다.
     ⚠ 판은 마크업에 없고 ctrymap.js 가 만듭니다 — b647 의 `?.` 덫을 피해
       **있는지를 먼저 묻습니다**(없는 것을 부정하면 「열려 있다」가 됩니다). */
  if ($('cmappane') && !$('cmappane').classList.contains('hide'))
    return closeCountryMap(true);
