...
import { photosOpen, closePhotos } from './photoview.js?v=b739';
import { sb } from './db.js?v=b739';
import { fail, netTimeout, drawOffbar, NOROW } from './net.js?v=b739';
import { D1, asDate, ymd, dayLabel } from './calc.js?v=b739';
import { trip, plans, legs, pickedDay, catFilter,
         setPickedDay, setPlans, setCatFilter, clearTrip } from './trip.js?v=b739';
import { drawCats, catsOpen, setCatsOpen } from './planline.js?v=b739';
import { drawPlanMap } from './planmap.js?v=b739';
import { drawPlans } from './planview.js?v=b739';
import { legIn, fillCityList } from './legs.js?v=b739';
import { inTrip } from './tabs.js?v=b739';
import { closeAi } from './aiscreen.js?v=b739';
import { closeDraft } from './draft.js?v=b739';
import { closeReview } from './home.js?v=b739';
/* 연속 평가(b409). 기록 탭을 통째로 덮으므로 뒤로가기가 여기를 먼저 닫습니다. */
import { closeSpree } from './spree.js?v=b739';
import { closeCity, isCityOpen } from './city.js?v=b739';
import { closeMap, closeCountries } from './map.js?v=b739';
import { closePersona } from './persona.js?v=b739';
/* 지구본 나라 카드(b555). 뒤로가기 사슬이 이것부터 닫습니다. */
import { 시트닫기 } from './home.js?v=b739';
import { closeShelf, 거르개닫기 } from './shelf.js?v=b739';
import { 나라거르개닫기 } from './rating.js?v=b739';
import { closeDiary } from './diary.js?v=b739';
import { closeDocs } from './prep.js?v=b739';
import { is16Open, isOne16Open, close16, closeOne16 } from './p16.js?v=b739';
...
window.addEventListener('popstate', () => {
  ...
  if ($('shsheet') && !$('shsheet').classList.contains('hide'))
    return 거르개닫기(true);
  /* ⚠⚠ **도감이 제일 위입니다(b737).** 성향 화면 위에 얹혀 열리고,
     그 안에서 상세가 «한 겹 더» 얹힙니다. 그래서 상세를 먼저 묻습니다 —
     차례를 바꾸면 상세에서 뒤로가기 한 번에 도감까지 같이 닫힙니다. */
  if (isOne16Open()) return closeOne16(true);
