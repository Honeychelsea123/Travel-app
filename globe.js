...
import { 가진땅, 나라셀, 도시있나, 상자자르기 } from './citymap.js?v=b710';
import { countryName } from './cities.js?v=b710';
import { visited, myRates } from './rate.js?v=b710';
...
export function mountGlobe(canvas, 갔다, 처음경도, 처음위도, 누름){
  ...
  /* ⚠ 다가갈 때만 손가락 한계(4배)를 넘습니다. 14배까지 갑니다 —
     그 나라를 «자세한» 윤곽으로 바꿔 그리므로 각져 보이지 않습니다(b696).
   ⚠ 14배가 필요한 나라는 전부 작은 나라(한국·프랑스·영국·싱가포르)라
     자료도 작습니다 — 자세히 못 받는 큰 나라는 애초에 배율이 1~2 입니다. */
  const 최대배 = () => 14;
