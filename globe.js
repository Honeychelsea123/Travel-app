...
import { 가진땅, 나라셀, 도시있나, 상자자르기 } from './citymap.js?v=b736';
import { countryName } from './cities.js?v=b736';
import { visited, myRates } from './rate.js?v=b736';
    ...
    /* ⚠ **확대하면 나라 칠이 옅어집니다(b707, 사용자 결정: 「나라칠은 옅게
       ...
       ⚠⚠ **0.62 → 0.94 로 더 걷었습니다(b713·b714).** ⚠⚠
         ...
         **칸 색이 아니라 이 칠이 문제였습니다.** 0.62 면 확대해도 0.38 이
         ...
         이제 **0.06** 만 남습니다(b714, 사용자가 고른 값). 겹쳐서 재면
           · 안 간 도시  1-(1-0.06)(1-0.03) = **0.088**
