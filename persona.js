...
import { $, esc, backLabel, toTop, coverDeck } from './dom.js?v=b542';
...
import { mateCode, mateHtml, shareMate } from './mate.js?v=b542';
import { visited } from './rate.js?v=b542';
import { personaStats, personaAxes, personaRank, personaMates, personaMrz,
         PERSONA16, AXIS_WORD, AXIS_NAME,
         shareCard, cardImage } from './card.js?v=b542';
  ...
  $('personabox').innerHTML = `
    ...
    <div class="card quiet">
      <div class="ptop" style="cursor:default">
        ...
        <div class="part"><img src="./persona/${esc(code)}.png?v=b542"
