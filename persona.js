...
import { $, esc, backLabel, toTop, coverDeck } from './dom.js?v=b567';
...
import { similarPicks } from './rec.js?v=b567';
  ...
  $('personabox').innerHTML = `
    ...
    <div class="card quiet" style="position:relative">
      ...
      <div class="ptop" style="cursor:default">
        ...
        <div class="part"><img src="./persona/${esc(code)}.png?v=b567"
