...
import { $, esc, backLabel, toTop, coverDeck } from './dom.js?v=b570';
...
import { mateCode, mateHtml } from './mate.js?v=b570';
import { visited } from './rate.js?v=b570';
import { personaStats, personaAxes, personaRank, personaMates, personaMrz,
         PERSONA16, AXIS_WORD, AXIS_NAME,
         shareCard } from './card.js?v=b570';
  ...
  $('personabox').innerHTML = `
    ...
    <div class="card quiet" style="position:relative">
      ...
      <div class="ptop" style="cursor:default">
        ...
        <div class="part"><img src="./persona/${esc(code)}.png?v=b570"
