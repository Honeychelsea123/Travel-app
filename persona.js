...
import { $, esc, toast, copyText } from './dom.js?v=b409';
import { sb } from './db.js?v=b409';
import { cities, countryName, continentOf } from './cities.js?v=b409';
/* 닮은 도시로 다음 갈 곳을 고릅니다. **AI 를 안 씁니다** — 오프라인에서도
   돌아야 하고 같은 자료에는 늘 같은 답이 나와야 합니다(rec.js 맨 위 참고). */
import { similarPicks } from './rec.js?v=b409';
/* 친구와 궁합. 유입이 유입을 만드는 고리입니다(b408) — mate.js 머리말 참고. */
import { mateCode, mateLink, mateHtml } from './mate.js?v=b409';
import { visited } from './rate.js?v=b409';
import { personaStats, personaAxes, personaRank, personaMates, personaMrz,
         PERSONA16, AXIS_WORD, AXIS_NAME,
         shareCard, cardImage } from './card.js?v=b409';
