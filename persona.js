...
import { $, esc, backLabel, toTop, coverDeck } from './dom.js?v=b707';
...
import { similarPicks } from './rec.js?v=b707';
  ...
  $('personabox').innerHTML = `
    ...
    <div class="card quiet" style="position:relative">
      ...
      <div class="ptop" style="cursor:default">
        ...
        <div class="part"><img src="./persona/${esc(code)}.png?v=b707"
