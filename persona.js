...
import { $, esc, backLabel, toTop, coverDeck } from './dom.js?v=b751';
...
async function drawPersona(s, ax, rates){
  ...
  const 바뀜배지 = (() => { try {
    ...
    return `<div class="pwas">
      <img class="pwasim" src="./persona/t/${esc(앞)}.jpg?v=b751"
