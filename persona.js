...
import { $, esc, backLabel } from './dom.js?v=b468';
import { sb } from './db.js?v=b468';
import { cities, countryName, continentOf } from './cities.js?v=b468';
...
import { mateCode, mateHtml, shareMate } from './mate.js?v=b468';
import { visited } from './rate.js?v=b468';
import { personaStats, personaAxes, personaRank, personaMates, personaMrz,
         PERSONA16, AXIS_WORD, AXIS_NAME,
         shareCard, cardImage } from './card.js?v=b468';
  ...
  $('personabox').innerHTML = `
    ...
    <div class="card quiet">
      <div class="ptop" style="cursor:default">
        ...
        <div class="part"><img src="./persona/${esc(code)}.png?v=b468"
