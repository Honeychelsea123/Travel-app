...
import { $, esc, backLabel } from './dom.js?v=b467';
import { sb } from './db.js?v=b467';
import { cities, countryName, continentOf } from './cities.js?v=b467';
...
import { mateCode, mateHtml, shareMate } from './mate.js?v=b467';
import { visited } from './rate.js?v=b467';
import { personaStats, personaAxes, personaRank, personaMates, personaMrz,
         PERSONA16, AXIS_WORD, AXIS_NAME,
         shareCard, cardImage } from './card.js?v=b467';
  ...
  $('personabox').innerHTML = `
    ...
    <div class="card quiet">
      <div class="ptop" style="cursor:default">
        ...
        <div class="part"><img src="./persona/${esc(code)}.png?v=b467"
