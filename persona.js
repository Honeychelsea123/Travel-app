...
import { $, esc, toast, copyText } from './dom.js?v=b415';
...
import { similarPicks } from './rec.js?v=b415';
/* 친구와 궁합. 유입이 유입을 만드는 고리입니다(b408) — mate.js 머리말 참고. */
import { mateCode, mateLink, mateHtml } from './mate.js?v=b415';
import { visited } from './rate.js?v=b415';
import { personaStats, personaAxes, personaRank, personaMates, personaMrz,
         PERSONA16, AXIS_WORD, AXIS_NAME,
         shareCard, cardImage } from './card.js?v=b415';
