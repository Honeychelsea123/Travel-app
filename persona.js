...
import { $, esc, toast, copyText } from './dom.js?v=b407';
...
import { similarPicks } from './rec.js?v=b407';
import { visited } from './rate.js?v=b407';
import { personaStats, personaAxes, personaRank, personaMates, personaMrz,
         PERSONA16, AXIS_WORD, AXIS_NAME,
         shareCard, cardImage } from './card.js?v=b407';
