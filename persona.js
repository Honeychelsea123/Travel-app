...
import { $, esc, backLabel, toTop, coverDeck } from './dom.js?v=b532';
import { sb } from './db.js?v=b532';
import { cities, countryName, continentOf } from './cities.js?v=b532';
...
import { mateCode, mateHtml, shareMate } from './mate.js?v=b532';
import { visited } from './rate.js?v=b532';
import { personaStats, personaAxes, personaRank, personaMates, personaMrz,
         PERSONA16, AXIS_WORD, AXIS_NAME,
         shareCard, cardImage } from './card.js?v=b532';
  ...
  $('personabox').innerHTML = `
    ...
    <div class="card quiet">
      <div class="ptop" style="cursor:default">
        ...
        <div class="part"><img src="./persona/${esc(code)}.png?v=b532"
