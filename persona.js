...
import { $, esc, backLabel, toTop, coverDeck } from './dom.js?v=b752';
...
async function drawPersona(s, ax, rates){
  ...
  const 바뀜배지 = (() => { try {
    ...
    return `<div class="pwas">
      <img class="pwasim" src="./persona/t/${esc(앞)}.jpg?v=b752"
  ...
  $('personabox').innerHTML = `
    ...
    <div class="card quiet" style="position:relative">
      ...
      <div class="phero">
        ...
        <div class="psizer"
             style="background-image:url('./persona/t/${esc(code)}.jpg?v=b752')"></div>
        ...
        <img src="./persona/m/${esc(code)}.jpg?v=b752" alt=""
