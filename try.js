...
import { paintStars } from './stars.js?v=b598';
/* 평가 히어로는 세 화면이 같은 것을 씁니다 — rateui.js 머리말 참고(b409). */
import { rateHero, starValue } from './rateui.js?v=b598';
import { personaAxes, personaRank, PERSONA16, AXIS_WORD, cardImage } from './card.js?v=b598';
/* 친구가 보낸 궁합 링크. 링크를 받은 사람이 실제로 도착하는 자리가 여기입니다. */
import { mateCode, mateHtml } from './mate.js?v=b598';
