...
import { paintStars } from './stars.js?v=b640';
/* 평가 히어로는 세 화면이 같은 것을 씁니다 — rateui.js 머리말 참고(b409). */
import { rateHero, starValue } from './rateui.js?v=b640';
import { personaAxes, personaRank, PERSONA16, AXIS_WORD, cardImage } from './card.js?v=b640';
