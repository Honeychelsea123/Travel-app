...
import { fail, netTimeout, netIsDown, drawOffbar, NOROW } from './net.js?v=b344';
import { dateRange } from './calc.js?v=b344';
import { starHtml, paintStars, markRated } from './stars.js?v=b344';
import { cities, countryName, addCity } from './cities.js?v=b344';
import { myRates, cityStat, visited, justRated, rateFilter, avgTail,
         setRateData, setVisited, applyRate, putCityStat, clearJustRated,
         putRateFilter } from './rate.js?v=b344';
