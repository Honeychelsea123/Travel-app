...
import { fail, netTimeout, netIsDown, drawOffbar, NOROW } from './net.js?v=b618';
import { dateRange } from './calc.js?v=b618';
import { starHtml, paintStars, markRated, starValue } from './stars.js?v=b618';
import { cities, countryName, addCity } from './cities.js?v=b618';
import { myRates, cityStat, visited, justRated, rateFilter, avgTail,
         setRateData, setVisited, applyRate, putCityStat, clearJustRated,
         putRateFilter, removeRate } from './rate.js?v=b618';
