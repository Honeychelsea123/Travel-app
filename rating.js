...
import { fail, netTimeout, netIsDown, drawOffbar, NOROW } from './net.js?v=b439';
import { dateRange } from './calc.js?v=b439';
import { starHtml, paintStars, markRated } from './stars.js?v=b439';
import { cities, countryName, addCity } from './cities.js?v=b439';
import { myRates, cityStat, visited, justRated, rateFilter, avgTail,
         setRateData, setVisited, applyRate, putCityStat, clearJustRated,
         putRateFilter, removeRate } from './rate.js?v=b439';
