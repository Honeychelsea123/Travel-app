...
import { fail, netTimeout, netIsDown, drawOffbar, NOROW } from './net.js?v=b353';
import { dateRange } from './calc.js?v=b353';
import { starHtml, paintStars, markRated } from './stars.js?v=b353';
import { cities, countryName, addCity } from './cities.js?v=b353';
import { myRates, cityStat, visited, justRated, rateFilter, avgTail,
         setRateData, setVisited, applyRate, putCityStat, clearJustRated,
         putRateFilter } from './rate.js?v=b353';
