...
import { fail, netTimeout, offNote, drawOffbar, cacheGet, cacheSet, NOROW } from './net.js?v=b527';
import { hm } from './calc.js?v=b527';
import { trip, bookings, setBookings, members, nameOf } from './trip.js?v=b527';
