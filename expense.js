...
import { fail, netTimeout, offNote, isOffline, write, drawOffbar } from './net.js?v=b661';
import { money, NO_CENTS, settleMath, dayLabel, legNear, todayYmd, hm } from './calc.js?v=b661';
import { trip, plans, legs, members, expenses, setExpenses, nameOf,
         pickedDay, tab, setSettleOn } from './trip.js?v=b661';
