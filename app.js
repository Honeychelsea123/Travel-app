...
import { $, esc, toast, copyText, md, avatarOf, avatarImg, emptyDo,
         putHtml, dropHtml, toTop, coverDeck } from './dom.js?v=b587';
import { starHtml, paintStars, markRated, armStarDrag } from './stars.js?v=b587';
import { fail, offNote, cacheGet, cacheSet, netIsDown, netTimeout, isOffline,
         write, flushQueue, drawOffbar, setOnDrained,
         setErrLogger, setReadOnly, NOROW } from './net.js?v=b587';
import { loadAdmin } from './admin.js?v=b587';
...
import { recommend, tasteOf, scoreCity, certainPicks } from './rec.js?v=b587';
import { arm, disarm, syncSheets, setSheetCloser, onSwipeX } from './ui.js?v=b587';
...
import { trip, plans, legs, members, expenses, bookings, transitLines,
         ...
         setEditPlanId, setPlanSeedGeo, nameOf } from './trip.js?v=b587';
/* 도시 평가. 네 화면이 같이 쓰는 자료라 한 곳이 어긋나면 넷이 같이 어긋납니다. */
import { myRates, cityStat, visited, justRated, rateFilter, avgTail,
         setRateData, setVisited, applyRate, putCityStat,
         clearJustRated, putRateFilter, clearRates } from './rate.js?v=b587';
/* 도시 사전과 찾기. 한 번 받으면 안 바뀝니다 — 여행이 바뀌어도 사람이 바뀌어도. */
import { cities, countryName, countryInfo, continentOf,
         useCities, addCity, search } from './cities.js?v=b587';
/* 여행 비서가 방금 내놓은 카드. 화면의 번호가 여기를 찾아가므로 통째로 갈아끼웁니다. */
import { suggested, aiTripId,
         setSuggested, clearSuggested, setAiTripId } from './ai.js?v=b587';
/* 성향 카드 화면. app.js 에서 떼어낸 첫 조각입니다(b321) — persona.js 머리말 참고. */
import { openPersona, closePersona, setPersonaCtx,
         personaBackTo } from './persona.js?v=b587';
import { setShiftCtx, clearPcode } from './pshift.js?v=b587';
...
import { openMap, closeMap, openCountries, closeCountries,
         shutBigMap, UN_COUNTRIES, setMapCtx } from './map.js?v=b587';
/* 보관함·배지. app.js 에서 떼어낸 세 번째 조각입니다(b323) — shelf.js 머리말 참고. */
import { openShelf, closeShelf, setShelfCtx } from './shelf.js?v=b587';
/* 일기장(b538) — 도시마다 남긴 일기를 한 장씩 넘겨 봅니다. */
import { openDiary, closeDiary, setDiaryCtx, diaryBackTo } from './diary.js?v=b587';
...
import { openCity, closeCity, setCityCtx,
         isCityOpen, clearCityOpen } from './city.js?v=b587';
...
import { showTyping, hideTyping, growMsg, fitJpeg, drawShot, drawSources,
         aiShots, SHOT_MAX, SRC_KO, setAiUiCtx } from './aiui.js?v=b587';
/* 여행 리포트. app.js 에서 떼어낸 여섯 번째 조각입니다(b333) — report.js 머리말 참고.
   이 화면은 끝에서 다른 화면으로 이어져서 ctx 가 깁니다(함수 다섯). */
import { drawReport, renderAiCard, setReportCtx } from './report.js?v=b587';
...
import { drawCards, openPlanForm, runReview,
         LVCOLOR, setCardsCtx } from './cards.js?v=b587';
import { loadExpenses, setExpenseCtx } from './expense.js?v=b587';
import { loadBookings, loadPacking, loadLinks, closeDocs } from './prep.js?v=b587';
import { loadMembers, handleJoin, ROLE_KO, setMemberCtx } from './member.js?v=b587';
import { drawPlanMap, mapLinks, memoMapUrl, splitParts, ensureLeaflet } from './planmap.js?v=b587';
import { loadCities, drawHits, drawPop, pick, picked, resetPick } from './citysearch.js?v=b587';
import { applyTs, setMyAvatar, setProfileCtx } from './profile.js?v=b587';
import { loadReview, setReviewCtx } from './review.js?v=b587';
import { loadRateData, loadRatings, drawRatings, saveRate, refreshVisited,
         setRateFilter, tripSub, resetRateHtml, setRatingCtx } from './rating.js?v=b587';
import { loadNotifPrefs, loadNotifs, setNotifyCtx } from './notify.js?v=b587';
import { openNew, movePrefs, setNewTripCtx } from './newtrip.js?v=b587';
/* 로그인 전 맛보기 평가(b406). 로그인 화면 안에서만 돕니다 — 앱 전체를
   익명에 열지 않습니다. 자세한 것은 try.js 머리말. */
import { drawTry, claimTryRates } from './try.js?v=b587';
/* 체크 카드로 들어온 사람(b488). 링크 ?check=eu 가 여기로 떨어집니다. */
/* 궁합 링크(?mate=CODE)를 주소에서 받아 담아둡니다 — mate.js 머리말 참고. */
import { catchMate } from './mate.js?v=b587';
/* 연속 평가 — 쭉 매기기(b409). 기록 탭에서 들어갑니다. spree.js 머리말 참고. */
import { openSpree, closeSpree, setSpreeCtx, spreeBackTo } from './spree.js?v=b587';
/* 분석 탭(b439) — 성향·지도로 가는 입구. 화면은 anal.js 가 그립니다. */
import { loadAnal, setAnalCtx } from './anal.js?v=b587';
import { loadHome, loadFootprint, heroTint, tripPhoto, closeReview,
         openTripReport, resetHomeSig, setHomeCtx } from './home.js?v=b587';
import { hhmm, osmLookup, setCandsCtx } from './cands.js?v=b587';
import './selfcheck.js?v=b587';
import { guessCat, setBringCtx } from './bring.js?v=b587';
import { loadTrash, TAB_TRASH, setTrashCtx } from './trash.js?v=b587';
import { review, mins, STAY_MIN, loadAi, setPlanCheckCtx } from './plancheck.js?v=b587';
import { openAi, closeAi, loadChats, aiToBottom, setAiScreenCtx } from './aiscreen.js?v=b587';
import { setAccountCtx } from './account.js?v=b587';
import { openDraft, closeDraft, setDraftCtx } from './draft.js?v=b587';
import { loadTrips, tripFilter, setTripFilter, setTripListCtx } from './triplist.js?v=b587';
import { inTrip, showTab, setTabsCtx } from './tabs.js?v=b587';
import { drawPlans, openPlans, setPlanViewCtx } from './planview.js?v=b587';
import { resetGeo, setGeocodeCtx } from './geocode.js?v=b587';
import { loadLegs, legIn, legFor, fillCityList, setLegsCtx } from './legs.js?v=b587';
import { drawDays, loadPlans, backToList, setTripViewCtx } from './tripview.js?v=b587';
import { drawToday } from './today.js?v=b587';
import { openTrip, fetchTrip, drawTripHeader, unwatch, setOpenTripCtx } from './opentrip.js?v=b587';
import { flags, featOn, loadFlags } from './flags.js?v=b587';
import { setSwRegCtx } from './swreg.js?v=b587';
import { drawCats, parseMemo, nice, lineChips, dayStat,
         catsOpen, setCatsOpen, setPlanLineCtx } from './planline.js?v=b587';
import { distKm, travel, hop, settleMath, dateRange, dayLabel, localTime, money,
         legAt, legNear, legFirst, travelMinutes, NO_CENTS, D1, asDate, hm, ymd, todayYmd } from './calc.js?v=b587';
