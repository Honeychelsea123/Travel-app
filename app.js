...
import { $, esc, toast, copyText, md, avatarOf, avatarImg, emptyDo,
         putHtml, dropHtml } from './dom.js?v=b379';
import { starHtml, paintStars, markRated } from './stars.js?v=b379';
import { fail, offNote, cacheGet, cacheSet, netIsDown, netTimeout, isOffline,
         write, flushQueue, drawOffbar, setOnDrained,
         setErrLogger, setReadOnly, NOROW } from './net.js?v=b379';
import { loadAdmin } from './admin.js?v=b379';
...
import { recommend, tasteOf, scoreCity, certainPicks } from './rec.js?v=b379';
import { arm, disarm, syncSheets, setSheetCloser, onSwipeX } from './ui.js?v=b379';
...
import { trip, plans, legs, members, expenses, bookings, transitLines,
         ...
         setEditPlanId, setPlanSeedGeo, nameOf } from './trip.js?v=b379';
/* 도시 평가. 네 화면이 같이 쓰는 자료라 한 곳이 어긋나면 넷이 같이 어긋납니다. */
import { myRates, cityStat, visited, justRated, rateFilter, avgTail,
         setRateData, setVisited, applyRate, putCityStat,
         clearJustRated, putRateFilter, clearRates } from './rate.js?v=b379';
/* 도시 사전과 찾기. 한 번 받으면 안 바뀝니다 — 여행이 바뀌어도 사람이 바뀌어도. */
import { cities, countryName, countryInfo, continentOf,
         useCities, addCity, search } from './cities.js?v=b379';
/* 여행 비서가 방금 내놓은 카드. 화면의 번호가 여기를 찾아가므로 통째로 갈아끼웁니다. */
import { suggested, aiTripId,
         setSuggested, clearSuggested, setAiTripId } from './ai.js?v=b379';
/* 성향 카드 화면. app.js 에서 떼어낸 첫 조각입니다(b321) — persona.js 머리말 참고. */
import { openPersona, closePersona, setPersonaCtx } from './persona.js?v=b379';
...
import { openMap, closeMap, openCountries, closeCountries,
         shutBigMap, UN_COUNTRIES, setMapCtx } from './map.js?v=b379';
/* 보관함·배지. app.js 에서 떼어낸 세 번째 조각입니다(b323) — shelf.js 머리말 참고. */
import { openShelf, closeShelf, setShelfCtx } from './shelf.js?v=b379';
...
import { openCity, closeCity, setCityCtx,
         isCityOpen, clearCityOpen } from './city.js?v=b379';
...
import { showTyping, hideTyping, growMsg, fitJpeg, drawShot, drawSources,
         aiShots, SHOT_MAX, SRC_KO, setAiUiCtx } from './aiui.js?v=b379';
/* 여행 리포트. app.js 에서 떼어낸 여섯 번째 조각입니다(b333) — report.js 머리말 참고.
   이 화면은 끝에서 다른 화면으로 이어져서 ctx 가 깁니다(함수 다섯). */
import { drawReport, renderAiCard, setReportCtx } from './report.js?v=b379';
...
import { drawCards, openPlanForm, runReview,
         LVCOLOR, setCardsCtx } from './cards.js?v=b379';
import { loadExpenses, setExpenseCtx } from './expense.js?v=b379';
import { loadBookings, loadPacking, loadLinks, closeDocs } from './prep.js?v=b379';
import { loadMembers, handleJoin, ROLE_KO, setMemberCtx } from './member.js?v=b379';
import { drawPlanMap, mapLinks, memoMapUrl, splitParts, ensureLeaflet } from './planmap.js?v=b379';
import { loadCities, drawHits, drawPop, pick, picked, resetPick } from './citysearch.js?v=b379';
import { applyTs, setMyAvatar, setProfileCtx } from './profile.js?v=b379';
import { loadReview, setReviewCtx } from './review.js?v=b379';
import { loadRateData, loadRatings, drawRatings, saveRate, refreshVisited,
         setRateFilter, tripSub, resetRateHtml, setRatingCtx } from './rating.js?v=b379';
import { loadNotifPrefs, loadNotifs, setNotifyCtx } from './notify.js?v=b379';
import { openNew, movePrefs, setNewTripCtx } from './newtrip.js?v=b379';
import { loadHome, loadFootprint, heroTint, tripPhoto, closeReview,
         openTripReport, resetHomeSig, setHomeCtx } from './home.js?v=b379';
import { hhmm, osmLookup, setCandsCtx } from './cands.js?v=b379';
import './selfcheck.js?v=b379';
import { guessCat, setBringCtx } from './bring.js?v=b379';
import { loadTrash, TAB_TRASH, setTrashCtx } from './trash.js?v=b379';
import { review, mins, STAY_MIN, loadAi, setPlanCheckCtx } from './plancheck.js?v=b379';
import { openAi, closeAi, loadChats, aiToBottom, setAiScreenCtx } from './aiscreen.js?v=b379';
import { setAccountCtx } from './account.js?v=b379';
import { openDraft, closeDraft, setDraftCtx } from './draft.js?v=b379';
import { loadTrips, tripFilter, setTripFilter, setTripListCtx } from './triplist.js?v=b379';
import { inTrip, showTab, setTabsCtx } from './tabs.js?v=b379';
import { drawPlans, openPlans, setPlanViewCtx } from './planview.js?v=b379';
import { resetGeo, setGeocodeCtx } from './geocode.js?v=b379';
import { loadLegs, legIn, legFor, fillCityList, setLegsCtx } from './legs.js?v=b379';
import { drawDays, loadPlans, backToList, setTripViewCtx } from './tripview.js?v=b379';
import { drawToday } from './today.js?v=b379';
import { openTrip, fetchTrip, drawTripHeader, unwatch, setOpenTripCtx } from './opentrip.js?v=b379';
import { flags, featOn, loadFlags } from './flags.js?v=b379';
import { setSwRegCtx } from './swreg.js?v=b379';
import { drawCats, parseMemo, nice, lineChips, dayStat,
         catsOpen, setCatsOpen, setPlanLineCtx } from './planline.js?v=b379';
import { PERSONA_ICON, REPORT_ICON, PERSONA_BG, REPORT_BG,
         askImageSize, personaStats, judgePersona, cardImage } from './card.js?v=b379';
import { distKm, travel, hop, settleMath, dateRange, dayLabel, localTime, money,
         legAt, legNear, legFirst, travelMinutes, NO_CENTS, D1, asDate, hm, ymd, todayYmd } from './calc.js?v=b379';
