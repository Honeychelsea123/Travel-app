 ...
 */
import { $, esc, coverDeck, toTop } from './dom.js?v=b740';
import { PERSONA16, AXIS_NAME, AXIS_WORD, personaMatch } from './card.js?v=b740';
...
function 격자(){
  ...
  const 칸 = 차례.map(code => {
    ...
    return `<button class="p16cell${나 ? ' mine' : ''}" data-p16go="${code}">
      <span class="sz"></span>
      <img src="./persona/t/${code}.jpg?v=b740" alt="" loading="lazy" decoding="async"
...
function 슬라이드(code){
  ...
  return `<div class="p16slide">
      <div class="phero">
        ...
        <img src="./persona/${code}.webp?v=b740" alt="" decoding="async"
