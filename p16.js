 ...
 */
import { $, esc, coverDeck, toTop } from './dom.js?v=b749';
import { PERSONA16, AXIS_NAME, AXIS_WORD, personaMatch } from './card.js?v=b749';
...
function 격자(){
  ...
  const 칸 = 코드들.map(code => {
    ...
    return `<button class="p16cell${나 ? ' mine' : ''}" data-p16go="${code}">
      <span class="sz"></span>
      <img src="./persona/t/${code}.jpg?v=b749" alt="" loading="lazy" decoding="async"
