...
const isCodeUrl = url =>
   ...
   *
   * ⚠ **b608 부터 제목 글꼴(Nanum Myeongjo)도 여기로 옵니다.**
   *   한글 글꼴은 라틴과 달리 **글자 묶음마다 파일이 따로** 옵니다
   *   (unicode-range 로 쪼개져 있습니다). 그래서 Dongle 한 조각이던
   *   자리에 수십 조각이 쌓입니다 — 다만 **쓰는 글자 몫만** 오고
   *   한 조각이 20KB 안팎이라 통이 터질 크기는 아닙니다.
   *   ⚠ 이 통은 **안 잘립니다.** 나중에 글꼴을 또 늘릴 일이 있으면
   *     그때는 여기 크기를 한 번 재보십시오. */
