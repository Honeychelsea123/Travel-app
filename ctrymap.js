...
import { $, esc, flagOf, flagOk, flagSprite, coverDeck } from './dom.js?v=b691';
import { cities, countryName, countryInfo } from './cities.js?v=b691';
import { myRates, visited } from './rate.js?v=b691';
