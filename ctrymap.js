...
import { $, esc, flagOf, flagOk, flagSprite, coverDeck } from './dom.js?v=b705';
import { cities, countryName, countryInfo } from './cities.js?v=b705';
import { myRates, visited } from './rate.js?v=b705';
