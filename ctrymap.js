...
import { $, esc, flagOf, flagOk, flagSprite, coverDeck } from './dom.js?v=b697';
import { cities, countryName, countryInfo } from './cities.js?v=b697';
import { myRates, visited } from './rate.js?v=b697';
