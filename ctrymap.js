...
import { $, esc, flagOf, flagOk, flagSprite, coverDeck } from './dom.js?v=b706';
import { cities, countryName, countryInfo } from './cities.js?v=b706';
import { myRates, visited } from './rate.js?v=b706';
