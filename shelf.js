...
import { $, esc, toast, emptyDo, josa, toTop, coverDeck, backLabel,
         flagOf, flagOk, flagSprite } from './dom.js?v=b741';
...
import { myRates, cityStat, visited, avgTail } from './rate.js?v=b741';
import { starHtml, paintStars, markRated, starValue, 별갈래, BAND_NAME } from './stars.js?v=b741';
import { fail } from './net.js?v=b741';
...
import { 발자국스펙 } from './map.js?v=b741';
import { shareCard } from './card.js?v=b741';
import { todayYmd } from './calc.js?v=b741';
...
import { UN_CODES, UN_TOTAL } from './un.js?v=b741';
import { loadCities } from './citysearch.js?v=b741';
import { loadRateData, saveRate } from './rating.js?v=b741';
