...
import { $, esc, toast, emptyDo, josa, toTop, coverDeck,
         flagOf, flagOk } from './dom.js?v=b632';
import { openCity } from './city.js?v=b632';
import { sb } from './db.js?v=b632';
import { cities, countryName } from './cities.js?v=b632';
import { myRates, cityStat, visited, avgTail } from './rate.js?v=b632';
import { starHtml, paintStars, markRated, starValue } from './stars.js?v=b632';
import { fail } from './net.js?v=b632';
import { arm } from './ui.js?v=b632';
import { todayYmd } from './calc.js?v=b632';
...
import { UN_CODES, UN_TOTAL } from './un.js?v=b632';
import { loadCities } from './citysearch.js?v=b632';
import { loadRateData, saveRate } from './rating.js?v=b632';
...
async function 깃발싣기(){
  if (깃발판) return true;
  try {
    const r = await fetch('./flags.svg?v=b632');
