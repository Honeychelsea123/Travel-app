...
import { $, esc, toast, emptyDo, josa, toTop, coverDeck } from './dom.js?v=b553';
import { openCity } from './city.js?v=b553';
import { sb } from './db.js?v=b553';
import { cities, countryName } from './cities.js?v=b553';
import { myRates, cityStat, visited, avgTail } from './rate.js?v=b553';
import { starHtml, paintStars, markRated, starValue } from './stars.js?v=b553';
...
import { loadRateData, saveRate } from './rating.js?v=b553';
