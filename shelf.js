...
import { $, esc, toast, emptyDo, josa, toTop, coverDeck, backLabel,
         flagOf, flagOk, flagSprite } from './dom.js?v=b751';
...
import { myRates, cityStat, visited, avgTail } from './rate.js?v=b751';
import { starHtml, paintStars, markRated, starValue, 별갈래, BAND_NAME } from './stars.js?v=b751';
import { fail } from './net.js?v=b751';
...
import { 발자국스펙 } from './map.js?v=b751';
import { shareCard } from './card.js?v=b751';
import { todayYmd } from './calc.js?v=b751';
...
import { UN_CODES, UN_TOTAL } from './un.js?v=b751';
import { loadCities } from './citysearch.js?v=b751';
import { loadRateData, saveRate } from './rating.js?v=b751';
