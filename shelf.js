...
import { myRates, cityStat, visited, avgTail } from './rate.js?v=b358';
import { starHtml, paintStars, markRated } from './stars.js?v=b358';
import { fail } from './net.js?v=b358';
import { arm } from './ui.js?v=b358';
import { todayYmd } from './calc.js?v=b358';
import { loadCities } from './citysearch.js?v=b358';
import { loadRateData, saveRate } from './rating.js?v=b358';
