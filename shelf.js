...
import { $, esc, toast, emptyDo, josa, toTop, coverDeck,
         flagOf, flagOk } from './dom.js?v=b625';
import { openCity } from './city.js?v=b625';
import { sb } from './db.js?v=b625';
import { cities, countryName } from './cities.js?v=b625';
import { myRates, cityStat, visited, avgTail } from './rate.js?v=b625';
import { starHtml, paintStars, markRated, starValue } from './stars.js?v=b625';
import { fail } from './net.js?v=b625';
import { arm } from './ui.js?v=b625';
import { todayYmd } from './calc.js?v=b625';
...
import { UN_CODES, UN_TOTAL } from './un.js?v=b625';
import { loadCities } from './citysearch.js?v=b625';
import { loadRateData, saveRate } from './rating.js?v=b625';
...
async function 깃발싣기(){
  if (깃발판) return true;
  try {
    const r = await fetch('./flags.svg?v=b625');
