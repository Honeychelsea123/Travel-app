...
import { $, esc, toast, emptyDo, josa, toTop, coverDeck,
         flagOf, flagOk, flagSprite } from './dom.js?v=b690';
...
import { myRates, cityStat, visited, avgTail } from './rate.js?v=b690';
import { starHtml, paintStars, markRated, starValue } from './stars.js?v=b690';
...
import { 발자국스펙 } from './map.js?v=b690';
import { shareCard } from './card.js?v=b690';
import { todayYmd } from './calc.js?v=b690';
...
import { UN_CODES, UN_TOTAL } from './un.js?v=b690';
import { loadCities } from './citysearch.js?v=b690';
import { loadRateData, saveRate } from './rating.js?v=b690';
