...
import { $, esc, toast, emptyDo, josa, toTop, coverDeck, backLabel,
         flagOf, flagOk, flagSprite } from './dom.js?v=b715';
...
import { myRates, cityStat, visited, avgTail } from './rate.js?v=b715';
...
import { 발자국스펙 } from './map.js?v=b715';
import { shareCard } from './card.js?v=b715';
import { todayYmd } from './calc.js?v=b715';
...
import { UN_CODES, UN_TOTAL } from './un.js?v=b715';
import { loadCities } from './citysearch.js?v=b715';
import { loadRateData, saveRate } from './rating.js?v=b715';
