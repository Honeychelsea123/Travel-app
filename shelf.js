...
import { $, esc, toast, emptyDo, josa, toTop, coverDeck,
         flagOf, flagOk } from './dom.js?v=b630';
import { openCity } from './city.js?v=b630';
import { sb } from './db.js?v=b630';
import { cities, countryName } from './cities.js?v=b630';
import { myRates, cityStat, visited, avgTail } from './rate.js?v=b630';
import { starHtml, paintStars, markRated, starValue } from './stars.js?v=b630';
...
import { UN_CODES, UN_TOTAL } from './un.js?v=b630';
import { loadCities } from './citysearch.js?v=b630';
import { loadRateData, saveRate } from './rating.js?v=b630';
...
async function 깃발싣기(){
  if (깃발판) return true;
  try {
    const r = await fetch('./flags.svg?v=b630');
