...
import { $, esc, toast, emptyDo, josa, toTop, coverDeck, backLabel,
         flagOf, flagOk, flagSprite } from './dom.js?v=b729';
...
import { myRates, cityStat, visited, avgTail } from './rate.js?v=b729';
import { starHtml, paintStars, markRated, starValue, 별갈래, BAND_NAME } from './stars.js?v=b729';
import { fail } from './net.js?v=b729';
...
import { 발자국스펙 } from './map.js?v=b729';
import { shareCard } from './card.js?v=b729';
import { todayYmd } from './calc.js?v=b729';
...
import { UN_CODES, UN_TOTAL } from './un.js?v=b729';
import { loadCities } from './citysearch.js?v=b729';
import { loadRateData, saveRate } from './rating.js?v=b729';
