...
import { $, esc, toast, emptyDo, josa, toTop, coverDeck, backLabel,
         flagOf, flagOk, flagSprite } from './dom.js?v=b709';
...
import { myRates, cityStat, visited, avgTail } from './rate.js?v=b709';
import { starHtml, paintStars, markRated, starValue } from './stars.js?v=b709';
import { fail } from './net.js?v=b709';
import { arm } from './ui.js?v=b709';
/* 깃발 벽의 공유는 지도·나라 목록과 **같은 카드**입니다(b649) — 셋 다
   「몇 개국 다녀왔다」를 말합니다. map.js 가 만들고 여기서 부르기만
   합니다. ⚠ map.js 는 shelf.js 를 안 가져오므로 고리가 안 생깁니다. */
import { 발자국스펙 } from './map.js?v=b709';
import { shareCard } from './card.js?v=b709';
import { todayYmd } from './calc.js?v=b709';
...
import { UN_CODES, UN_TOTAL } from './un.js?v=b709';
import { loadCities } from './citysearch.js?v=b709';
import { loadRateData, saveRate } from './rating.js?v=b709';
