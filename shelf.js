...
import { myRates, cityStat, visited, avgTail } from './rate.js?v=b359';
import { starHtml, paintStars, markRated } from './stars.js?v=b359';
import { fail } from './net.js?v=b359';
import { arm } from './ui.js?v=b359';
import { todayYmd } from './calc.js?v=b359';
import { loadCities } from './citysearch.js?v=b359';
import { loadRateData, saveRate } from './rating.js?v=b359';
