...
import { $, esc, toast, emptyDo, josa, toTop, coverDeck, backLabel,
         flagOf, flagOk, flagSprite } from './dom.js?v=b716';
...
import { myRates, cityStat, visited, avgTail } from './rate.js?v=b716';
...
import { 발자국스펙 } from './map.js?v=b716';
import { shareCard } from './card.js?v=b716';
import { todayYmd } from './calc.js?v=b716';
...
import { UN_CODES, UN_TOTAL } from './un.js?v=b716';
import { loadCities } from './citysearch.js?v=b716';
import { loadRateData, saveRate } from './rating.js?v=b716';
