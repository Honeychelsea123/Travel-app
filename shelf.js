...
import { $, esc, toast, emptyDo, josa, toTop, coverDeck,
         flagOf, flagOk, flagSprite } from './dom.js?v=b677';
...
import { myRates, cityStat, visited, avgTail } from './rate.js?v=b677';
import { starHtml, paintStars, markRated, starValue } from './stars.js?v=b677';
import { fail } from './net.js?v=b677';
...
import { 발자국스펙 } from './map.js?v=b677';
import { shareCard } from './card.js?v=b677';
import { todayYmd } from './calc.js?v=b677';
...
import { UN_CODES, UN_TOTAL } from './un.js?v=b677';
import { loadCities } from './citysearch.js?v=b677';
import { loadRateData, saveRate } from './rating.js?v=b677';
