...
import { $, esc, toast, emptyDo, josa, toTop, coverDeck,
         flagOf, flagOk } from './dom.js?v=b629';
import { openCity } from './city.js?v=b629';
import { sb } from './db.js?v=b629';
import { cities, countryName } from './cities.js?v=b629';
import { myRates, cityStat, visited, avgTail } from './rate.js?v=b629';
import { starHtml, paintStars, markRated, starValue } from './stars.js?v=b629';
import { fail } from './net.js?v=b629';
import { arm } from './ui.js?v=b629';
import { todayYmd } from './calc.js?v=b629';
...
import { UN_CODES, UN_TOTAL } from './un.js?v=b629';
import { loadCities } from './citysearch.js?v=b629';
import { loadRateData, saveRate } from './rating.js?v=b629';
...
async function 깃발싣기(){
  if (깃발판) return true;
  try {
    const r = await fetch('./flags.svg?v=b629');
