...
import { $, esc, toast, emptyDo, josa, toTop, coverDeck } from './dom.js?v=b525';
import { openCity } from './city.js?v=b525';
import { sb } from './db.js?v=b525';
import { cities, countryName } from './cities.js?v=b525';
import { myRates, cityStat, visited, avgTail } from './rate.js?v=b525';
...
import { loadRateData, saveRate } from './rating.js?v=b525';
