...
import { $, esc, toast, emptyDo, josa, toTop, coverDeck,
         flagOf, flagOk } from './dom.js?v=b633';
import { openCity } from './city.js?v=b633';
import { sb } from './db.js?v=b633';
import { cities, countryName } from './cities.js?v=b633';
import { myRates, cityStat, visited, avgTail } from './rate.js?v=b633';
import { starHtml, paintStars, markRated, starValue } from './stars.js?v=b633';
import { fail } from './net.js?v=b633';
import { arm } from './ui.js?v=b633';
import { todayYmd } from './calc.js?v=b633';
...
import { UN_CODES, UN_TOTAL } from './un.js?v=b633';
import { loadCities } from './citysearch.js?v=b633';
import { loadRateData, saveRate } from './rating.js?v=b633';
...
async function 깃발싣기(){
  if (깃발판) return true;
  try {
    const r = await fetch('./flags.svg?v=b633');
