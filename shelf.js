...
import { $, esc, toast, emptyDo, josa, toTop, coverDeck,
         flagOf, flagOk } from './dom.js?v=b639';
import { openCity } from './city.js?v=b639';
import { sb } from './db.js?v=b639';
import { cities, countryName } from './cities.js?v=b639';
import { myRates, cityStat, visited, avgTail } from './rate.js?v=b639';
import { starHtml, paintStars, markRated, starValue } from './stars.js?v=b639';
import { fail } from './net.js?v=b639';
import { arm } from './ui.js?v=b639';
import { todayYmd } from './calc.js?v=b639';
...
import { UN_CODES, UN_TOTAL } from './un.js?v=b639';
import { loadCities } from './citysearch.js?v=b639';
import { loadRateData, saveRate } from './rating.js?v=b639';
...
async function 깃발싣기(){
  if (깃발판) return true;
  try {
    const r = await fetch('./flags.svg?v=b639');
