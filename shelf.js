...
import { $, esc, toast, emptyDo, josa, toTop, coverDeck,
         flagOf, flagOk, flagSprite } from './dom.js?v=b678';
...
import { myRates, cityStat, visited, avgTail } from './rate.js?v=b678';
import { starHtml, paintStars, markRated, starValue } from './stars.js?v=b678';
import { fail } from './net.js?v=b678';
...
import { 발자국스펙 } from './map.js?v=b678';
import { shareCard } from './card.js?v=b678';
import { todayYmd } from './calc.js?v=b678';
...
import { UN_CODES, UN_TOTAL } from './un.js?v=b678';
import { loadCities } from './citysearch.js?v=b678';
import { loadRateData, saveRate } from './rating.js?v=b678';
