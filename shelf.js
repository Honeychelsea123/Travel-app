...
import { $, esc, toast, emptyDo, josa, toTop, coverDeck,
         flagOf, flagOk } from './dom.js?v=b626';
import { openCity } from './city.js?v=b626';
import { sb } from './db.js?v=b626';
import { cities, countryName } from './cities.js?v=b626';
import { myRates, cityStat, visited, avgTail } from './rate.js?v=b626';
import { starHtml, paintStars, markRated, starValue } from './stars.js?v=b626';
import { fail } from './net.js?v=b626';
import { arm } from './ui.js?v=b626';
import { todayYmd } from './calc.js?v=b626';
...
import { UN_CODES, UN_TOTAL } from './un.js?v=b626';
import { loadCities } from './citysearch.js?v=b626';
import { loadRateData, saveRate } from './rating.js?v=b626';
...
async function 깃발싣기(){
  if (깃발판) return true;
  try {
    const r = await fetch('./flags.svg?v=b626');
