...
import { $, esc, toast, emptyDo, josa, toTop, coverDeck,
         flagOf, flagOk, flagSprite } from './dom.js?v=b686';
...
import { myRates, cityStat, visited, avgTail } from './rate.js?v=b686';
...
import { 발자국스펙 } from './map.js?v=b686';
import { shareCard } from './card.js?v=b686';
import { todayYmd } from './calc.js?v=b686';
...
import { UN_CODES, UN_TOTAL } from './un.js?v=b686';
import { loadCities } from './citysearch.js?v=b686';
import { loadRateData, saveRate } from './rating.js?v=b686';
