...
import { $, esc, toast, emptyDo, josa, toTop, coverDeck,
         flagOf, flagOk, flagSprite } from './dom.js?v=b685';
...
import { myRates, cityStat, visited, avgTail } from './rate.js?v=b685';
import { starHtml, paintStars, markRated, starValue } from './stars.js?v=b685';
import { fail } from './net.js?v=b685';
...
import { 발자국스펙 } from './map.js?v=b685';
import { shareCard } from './card.js?v=b685';
import { todayYmd } from './calc.js?v=b685';
...
import { UN_CODES, UN_TOTAL } from './un.js?v=b685';
import { loadCities } from './citysearch.js?v=b685';
import { loadRateData, saveRate } from './rating.js?v=b685';
