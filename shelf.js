...
import { $, esc, toast, emptyDo, josa, toTop, coverDeck, backLabel,
         flagOf, flagOk, flagSprite } from './dom.js?v=b742';
...
import { myRates, cityStat, visited, avgTail } from './rate.js?v=b742';
import { starHtml, paintStars, markRated, starValue, 별갈래, BAND_NAME } from './stars.js?v=b742';
import { fail } from './net.js?v=b742';
...
import { 발자국스펙 } from './map.js?v=b742';
import { shareCard } from './card.js?v=b742';
import { todayYmd } from './calc.js?v=b742';
...
import { UN_CODES, UN_TOTAL } from './un.js?v=b742';
import { loadCities } from './citysearch.js?v=b742';
import { loadRateData, saveRate } from './rating.js?v=b742';
