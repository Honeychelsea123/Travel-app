...
import { $, esc, toast, emptyDo, josa, toTop, coverDeck } from './dom.js?v=b500';
import { openCity } from './city.js?v=b500';
import { sb } from './db.js?v=b500';
import { cities, countryName } from './cities.js?v=b500';
import { myRates, cityStat, visited, avgTail } from './rate.js?v=b500';
...
import { loadRateData, saveRate } from './rating.js?v=b500';
