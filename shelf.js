...
import { $, esc, toast, emptyDo, josa, toTop, coverDeck,
         flagOf, flagOk } from './dom.js?v=b631';
import { openCity } from './city.js?v=b631';
import { sb } from './db.js?v=b631';
import { cities, countryName } from './cities.js?v=b631';
import { myRates, cityStat, visited, avgTail } from './rate.js?v=b631';
import { starHtml, paintStars, markRated, starValue } from './stars.js?v=b631';
import { fail } from './net.js?v=b631';
import { arm } from './ui.js?v=b631';
import { todayYmd } from './calc.js?v=b631';
...
import { UN_CODES, UN_TOTAL } from './un.js?v=b631';
import { loadCities } from './citysearch.js?v=b631';
import { loadRateData, saveRate } from './rating.js?v=b631';
...
async function 깃발싣기(){
  if (깃발판) return true;
  try {
    const r = await fetch('./flags.svg?v=b631');
