...
import { $, esc, toast, emptyDo, josa, toTop, coverDeck, backLabel,
         flagOf, flagOk, flagSprite } from './dom.js?v=b730';
...
import { myRates, cityStat, visited, avgTail } from './rate.js?v=b730';
import { starHtml, paintStars, markRated, starValue, 별갈래, BAND_NAME } from './stars.js?v=b730';
...
import { 발자국스펙 } from './map.js?v=b730';
...
import { UN_CODES, UN_TOTAL } from './un.js?v=b730';
import { loadCities } from './citysearch.js?v=b730';
import { loadRateData, saveRate } from './rating.js?v=b730';
