...
2026-08-18. `app.js` 9,169 → 5,762줄. 열한 조각이 나갔다. **처음의 37%가 남았다.**
...
|---|---|---|---|---|
| **도시 검색** | 805–1034 | 230 | **0** | loadCities · pick · drawHits · drawPop |
| **프로필** | 3237–3337 | 101 | **1** (me) | applyTs · shrink |
| **여행 후기 · 후기 사진** | 3887–4090 | 204 | **2** (me, shrink) | loadReview |
| 내 자료 내려받기 | 3052–3236 | 185 | 4 | — |
| 평가 화면 | 1533–1817 | 285 | 4 | — |
| 후보와 빈 시간 | 2484–2791 | 308 | 4 | — |
| 알림(설정·푸시) | 324–607 | 284 | 7 | — |
| 여기 가봤어요 · 발자국 | 2227–2483 | 257 | 7 | — |
| 여행 만들기 · 달력 | 1035–1281 | 247 | 7 | — |
| AI 일정 초안 | 2792–3051 | 260 | 9 | — |
| 여행 목록의 사진 | 3338–3565 | 228 | 9 | — |
| 여행 정보 수정 | 4091–4316 | 226 | 12 | — |
| 홈(히어로 · 끝난 뒤) | 1818–2221 | 404 | 12 | — |

**위 셋(ctx 0~2, 535줄)이 지금 제일 싸다.** `도시 검색` 은 딸린 것이 아예
없다 — `loadCities` 를 app.js 가 12곳에서 부르지만 그건 **내보내면 되는 것**
이지 ctx 가 아니다. 방향이 반대다.
