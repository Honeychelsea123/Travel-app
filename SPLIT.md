...
2026-08-19. `app.js` 9,169 → 3,571줄. 열아홉 조각이 나갔다. **61%를 걷었다.**
...
**일정을 먼저 자르면 나머지가 싸진다.** 일정 안에서 잘라볼 자리:
끌어서 순서 바꾸기(227) · 일정 불러오기(161) · 오늘 화면(116) ·
지운 것 되살리기(90) · 탭과 쓸어넘기기(130). 각각 재보고 ctx 가 적은
것부터 떼면, 남은 `여행 정보 수정` 의 ctx 12 도 같이 줄어든다.
