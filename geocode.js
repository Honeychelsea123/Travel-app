...
import { $, toast } from './dom.js?v=b355';
import { sb } from './db.js?v=b355';
import { fail, write } from './net.js?v=b355';
import { trip, plans, setPlans, editPlanId, setEditPlanId } from './trip.js?v=b355';
import { arm } from './ui.js?v=b355';
import { drawCats } from './planline.js?v=b355';
import { drawPlanMap } from './planmap.js?v=b355';
import { drawPlans } from './planview.js?v=b355';
import { osmLookup } from './cands.js?v=b355';

let ctx = { drawDays: () => {}, featOn: () => false, loadPlans: async () => {} };
