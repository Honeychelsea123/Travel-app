...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b389';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b389';
import { drawCats } from './planline.js?v=b389';
import { drawPlanMap } from './planmap.js?v=b389';
import { drawPlans, openPlans } from './planview.js?v=b389';
import { STAY_MIN, mins } from './plancheck.js?v=b389';
import { hhmm } from './cands.js?v=b389';
import { legFor } from './legs.js?v=b389';
import { drawDays } from './tripview.js?v=b389';
