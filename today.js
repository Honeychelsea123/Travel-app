...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b432';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b432';
import { drawCats } from './planline.js?v=b432';
import { drawPlanMap } from './planmap.js?v=b432';
import { drawPlans, openPlans } from './planview.js?v=b432';
import { STAY_MIN, mins } from './plancheck.js?v=b432';
import { hhmm } from './cands.js?v=b432';
import { legFor } from './legs.js?v=b432';
import { drawDays } from './tripview.js?v=b432';
