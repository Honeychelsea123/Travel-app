...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b436';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b436';
import { drawCats } from './planline.js?v=b436';
import { drawPlanMap } from './planmap.js?v=b436';
import { drawPlans, openPlans } from './planview.js?v=b436';
import { STAY_MIN, mins } from './plancheck.js?v=b436';
import { hhmm } from './cands.js?v=b436';
import { legFor } from './legs.js?v=b436';
import { drawDays } from './tripview.js?v=b436';
