...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b429';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b429';
import { drawCats } from './planline.js?v=b429';
import { drawPlanMap } from './planmap.js?v=b429';
import { drawPlans, openPlans } from './planview.js?v=b429';
import { STAY_MIN, mins } from './plancheck.js?v=b429';
import { hhmm } from './cands.js?v=b429';
import { legFor } from './legs.js?v=b429';
import { drawDays } from './tripview.js?v=b429';
