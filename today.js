...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b584';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b584';
import { drawCats } from './planline.js?v=b584';
import { drawPlanMap } from './planmap.js?v=b584';
import { drawPlans, openPlans } from './planview.js?v=b584';
import { STAY_MIN, mins } from './plancheck.js?v=b584';
import { hhmm } from './cands.js?v=b584';
import { legFor } from './legs.js?v=b584';
import { drawDays } from './tripview.js?v=b584';
