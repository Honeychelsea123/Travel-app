...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b716';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b716';
import { drawCats } from './planline.js?v=b716';
import { drawPlanMap } from './planmap.js?v=b716';
import { drawPlans, openPlans } from './planview.js?v=b716';
import { STAY_MIN, mins } from './plancheck.js?v=b716';
import { hhmm } from './cands.js?v=b716';
import { legFor } from './legs.js?v=b716';
import { drawDays } from './tripview.js?v=b716';
