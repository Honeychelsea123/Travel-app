...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b654';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b654';
import { drawCats } from './planline.js?v=b654';
import { drawPlanMap } from './planmap.js?v=b654';
import { drawPlans, openPlans } from './planview.js?v=b654';
import { STAY_MIN, mins } from './plancheck.js?v=b654';
import { hhmm } from './cands.js?v=b654';
import { legFor } from './legs.js?v=b654';
import { drawDays } from './tripview.js?v=b654';
