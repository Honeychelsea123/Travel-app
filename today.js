...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b555';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b555';
import { drawCats } from './planline.js?v=b555';
import { drawPlanMap } from './planmap.js?v=b555';
import { drawPlans, openPlans } from './planview.js?v=b555';
import { STAY_MIN, mins } from './plancheck.js?v=b555';
import { hhmm } from './cands.js?v=b555';
import { legFor } from './legs.js?v=b555';
import { drawDays } from './tripview.js?v=b555';
