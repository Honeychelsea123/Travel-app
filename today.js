...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b587';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b587';
import { drawCats } from './planline.js?v=b587';
import { drawPlanMap } from './planmap.js?v=b587';
import { drawPlans, openPlans } from './planview.js?v=b587';
import { STAY_MIN, mins } from './plancheck.js?v=b587';
import { hhmm } from './cands.js?v=b587';
import { legFor } from './legs.js?v=b587';
import { drawDays } from './tripview.js?v=b587';
