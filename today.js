...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b603';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b603';
import { drawCats } from './planline.js?v=b603';
import { drawPlanMap } from './planmap.js?v=b603';
import { drawPlans, openPlans } from './planview.js?v=b603';
import { STAY_MIN, mins } from './plancheck.js?v=b603';
import { hhmm } from './cands.js?v=b603';
import { legFor } from './legs.js?v=b603';
import { drawDays } from './tripview.js?v=b603';
