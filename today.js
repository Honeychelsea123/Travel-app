...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b386';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b386';
import { drawCats } from './planline.js?v=b386';
import { drawPlanMap } from './planmap.js?v=b386';
import { drawPlans, openPlans } from './planview.js?v=b386';
import { STAY_MIN, mins } from './plancheck.js?v=b386';
import { hhmm } from './cands.js?v=b386';
import { legFor } from './legs.js?v=b386';
import { drawDays } from './tripview.js?v=b386';
