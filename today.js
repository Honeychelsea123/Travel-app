...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b536';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b536';
import { drawCats } from './planline.js?v=b536';
import { drawPlanMap } from './planmap.js?v=b536';
import { drawPlans, openPlans } from './planview.js?v=b536';
import { STAY_MIN, mins } from './plancheck.js?v=b536';
import { hhmm } from './cands.js?v=b536';
import { legFor } from './legs.js?v=b536';
import { drawDays } from './tripview.js?v=b536';
