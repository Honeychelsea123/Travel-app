...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b585';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b585';
import { drawCats } from './planline.js?v=b585';
import { drawPlanMap } from './planmap.js?v=b585';
import { drawPlans, openPlans } from './planview.js?v=b585';
import { STAY_MIN, mins } from './plancheck.js?v=b585';
import { hhmm } from './cands.js?v=b585';
import { legFor } from './legs.js?v=b585';
import { drawDays } from './tripview.js?v=b585';
