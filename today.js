...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b440';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b440';
import { drawCats } from './planline.js?v=b440';
import { drawPlanMap } from './planmap.js?v=b440';
import { drawPlans, openPlans } from './planview.js?v=b440';
import { STAY_MIN, mins } from './plancheck.js?v=b440';
import { hhmm } from './cands.js?v=b440';
import { legFor } from './legs.js?v=b440';
import { drawDays } from './tripview.js?v=b440';
