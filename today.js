...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b418';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b418';
import { drawCats } from './planline.js?v=b418';
import { drawPlanMap } from './planmap.js?v=b418';
import { drawPlans, openPlans } from './planview.js?v=b418';
import { STAY_MIN, mins } from './plancheck.js?v=b418';
import { hhmm } from './cands.js?v=b418';
import { legFor } from './legs.js?v=b418';
import { drawDays } from './tripview.js?v=b418';
