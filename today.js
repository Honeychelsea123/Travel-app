...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b384';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b384';
import { drawCats } from './planline.js?v=b384';
import { drawPlanMap } from './planmap.js?v=b384';
import { drawPlans, openPlans } from './planview.js?v=b384';
import { STAY_MIN, mins } from './plancheck.js?v=b384';
import { hhmm } from './cands.js?v=b384';
import { legFor } from './legs.js?v=b384';
import { drawDays } from './tripview.js?v=b384';
