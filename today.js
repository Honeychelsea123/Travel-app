...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b735';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b735';
import { drawCats } from './planline.js?v=b735';
import { drawPlanMap } from './planmap.js?v=b735';
import { drawPlans, openPlans } from './planview.js?v=b735';
import { STAY_MIN, mins } from './plancheck.js?v=b735';
import { hhmm } from './cands.js?v=b735';
import { legFor } from './legs.js?v=b735';
import { drawDays } from './tripview.js?v=b735';
