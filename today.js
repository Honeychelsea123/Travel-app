...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b709';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b709';
import { drawCats } from './planline.js?v=b709';
import { drawPlanMap } from './planmap.js?v=b709';
import { drawPlans, openPlans } from './planview.js?v=b709';
import { STAY_MIN, mins } from './plancheck.js?v=b709';
import { hhmm } from './cands.js?v=b709';
import { legFor } from './legs.js?v=b709';
import { drawDays } from './tripview.js?v=b709';
