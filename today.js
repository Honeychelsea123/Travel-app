...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b514';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b514';
import { drawCats } from './planline.js?v=b514';
import { drawPlanMap } from './planmap.js?v=b514';
import { drawPlans, openPlans } from './planview.js?v=b514';
import { STAY_MIN, mins } from './plancheck.js?v=b514';
import { hhmm } from './cands.js?v=b514';
import { legFor } from './legs.js?v=b514';
import { drawDays } from './tripview.js?v=b514';
