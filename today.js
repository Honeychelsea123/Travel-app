...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b437';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b437';
import { drawCats } from './planline.js?v=b437';
import { drawPlanMap } from './planmap.js?v=b437';
import { drawPlans, openPlans } from './planview.js?v=b437';
import { STAY_MIN, mins } from './plancheck.js?v=b437';
import { hhmm } from './cands.js?v=b437';
import { legFor } from './legs.js?v=b437';
import { drawDays } from './tripview.js?v=b437';
