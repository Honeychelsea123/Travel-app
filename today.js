...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b623';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b623';
import { drawCats } from './planline.js?v=b623';
import { drawPlanMap } from './planmap.js?v=b623';
import { drawPlans, openPlans } from './planview.js?v=b623';
import { STAY_MIN, mins } from './plancheck.js?v=b623';
import { hhmm } from './cands.js?v=b623';
import { legFor } from './legs.js?v=b623';
import { drawDays } from './tripview.js?v=b623';
