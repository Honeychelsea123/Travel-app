...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b699';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b699';
import { drawCats } from './planline.js?v=b699';
import { drawPlanMap } from './planmap.js?v=b699';
import { drawPlans, openPlans } from './planview.js?v=b699';
import { STAY_MIN, mins } from './plancheck.js?v=b699';
import { hhmm } from './cands.js?v=b699';
import { legFor } from './legs.js?v=b699';
import { drawDays } from './tripview.js?v=b699';
