...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b509';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b509';
import { drawCats } from './planline.js?v=b509';
import { drawPlanMap } from './planmap.js?v=b509';
import { drawPlans, openPlans } from './planview.js?v=b509';
import { STAY_MIN, mins } from './plancheck.js?v=b509';
import { hhmm } from './cands.js?v=b509';
import { legFor } from './legs.js?v=b509';
import { drawDays } from './tripview.js?v=b509';
