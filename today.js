...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b369';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b369';
import { drawCats } from './planline.js?v=b369';
import { drawPlanMap } from './planmap.js?v=b369';
import { drawPlans, openPlans } from './planview.js?v=b369';
import { STAY_MIN, mins } from './plancheck.js?v=b369';
import { hhmm } from './cands.js?v=b369';
import { legFor } from './legs.js?v=b369';
import { drawDays } from './tripview.js?v=b369';
