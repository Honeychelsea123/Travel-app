...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b365';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b365';
import { drawCats } from './planline.js?v=b365';
import { drawPlanMap } from './planmap.js?v=b365';
import { drawPlans, openPlans } from './planview.js?v=b365';
import { STAY_MIN, mins } from './plancheck.js?v=b365';
import { hhmm } from './cands.js?v=b365';
import { legFor } from './legs.js?v=b365';
import { drawDays } from './tripview.js?v=b365';
