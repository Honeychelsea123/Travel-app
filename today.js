...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b595';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b595';
import { drawCats } from './planline.js?v=b595';
import { drawPlanMap } from './planmap.js?v=b595';
import { drawPlans, openPlans } from './planview.js?v=b595';
import { STAY_MIN, mins } from './plancheck.js?v=b595';
import { hhmm } from './cands.js?v=b595';
import { legFor } from './legs.js?v=b595';
import { drawDays } from './tripview.js?v=b595';
