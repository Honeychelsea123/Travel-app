...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b708';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b708';
import { drawCats } from './planline.js?v=b708';
import { drawPlanMap } from './planmap.js?v=b708';
import { drawPlans, openPlans } from './planview.js?v=b708';
import { STAY_MIN, mins } from './plancheck.js?v=b708';
import { hhmm } from './cands.js?v=b708';
import { legFor } from './legs.js?v=b708';
import { drawDays } from './tripview.js?v=b708';
