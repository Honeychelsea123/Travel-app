...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b563';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b563';
import { drawCats } from './planline.js?v=b563';
import { drawPlanMap } from './planmap.js?v=b563';
import { drawPlans, openPlans } from './planview.js?v=b563';
import { STAY_MIN, mins } from './plancheck.js?v=b563';
import { hhmm } from './cands.js?v=b563';
import { legFor } from './legs.js?v=b563';
import { drawDays } from './tripview.js?v=b563';
