...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b500';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b500';
import { drawCats } from './planline.js?v=b500';
import { drawPlanMap } from './planmap.js?v=b500';
import { drawPlans, openPlans } from './planview.js?v=b500';
import { STAY_MIN, mins } from './plancheck.js?v=b500';
import { hhmm } from './cands.js?v=b500';
import { legFor } from './legs.js?v=b500';
import { drawDays } from './tripview.js?v=b500';
