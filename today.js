...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b666';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b666';
import { drawCats } from './planline.js?v=b666';
import { drawPlanMap } from './planmap.js?v=b666';
import { drawPlans, openPlans } from './planview.js?v=b666';
import { STAY_MIN, mins } from './plancheck.js?v=b666';
import { hhmm } from './cands.js?v=b666';
import { legFor } from './legs.js?v=b666';
import { drawDays } from './tripview.js?v=b666';
