...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b380';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b380';
import { drawCats } from './planline.js?v=b380';
import { drawPlanMap } from './planmap.js?v=b380';
import { drawPlans, openPlans } from './planview.js?v=b380';
import { STAY_MIN, mins } from './plancheck.js?v=b380';
import { hhmm } from './cands.js?v=b380';
import { legFor } from './legs.js?v=b380';
import { drawDays } from './tripview.js?v=b380';
