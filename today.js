...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b517';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b517';
import { drawCats } from './planline.js?v=b517';
import { drawPlanMap } from './planmap.js?v=b517';
import { drawPlans, openPlans } from './planview.js?v=b517';
import { STAY_MIN, mins } from './plancheck.js?v=b517';
import { hhmm } from './cands.js?v=b517';
import { legFor } from './legs.js?v=b517';
import { drawDays } from './tripview.js?v=b517';
