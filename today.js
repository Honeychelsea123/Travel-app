...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b501';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b501';
import { drawCats } from './planline.js?v=b501';
import { drawPlanMap } from './planmap.js?v=b501';
import { drawPlans, openPlans } from './planview.js?v=b501';
import { STAY_MIN, mins } from './plancheck.js?v=b501';
import { hhmm } from './cands.js?v=b501';
import { legFor } from './legs.js?v=b501';
import { drawDays } from './tripview.js?v=b501';
