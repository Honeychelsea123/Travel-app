...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b556';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b556';
import { drawCats } from './planline.js?v=b556';
import { drawPlanMap } from './planmap.js?v=b556';
import { drawPlans, openPlans } from './planview.js?v=b556';
import { STAY_MIN, mins } from './plancheck.js?v=b556';
import { hhmm } from './cands.js?v=b556';
import { legFor } from './legs.js?v=b556';
import { drawDays } from './tripview.js?v=b556';
