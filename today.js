...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b727';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b727';
import { drawCats } from './planline.js?v=b727';
import { drawPlanMap } from './planmap.js?v=b727';
import { drawPlans, openPlans } from './planview.js?v=b727';
import { STAY_MIN, mins } from './plancheck.js?v=b727';
import { hhmm } from './cands.js?v=b727';
import { legFor } from './legs.js?v=b727';
import { drawDays } from './tripview.js?v=b727';
