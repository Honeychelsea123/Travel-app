...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b750';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b750';
import { drawCats } from './planline.js?v=b750';
import { drawPlanMap } from './planmap.js?v=b750';
import { drawPlans, openPlans } from './planview.js?v=b750';
import { STAY_MIN, mins } from './plancheck.js?v=b750';
import { hhmm } from './cands.js?v=b750';
import { legFor } from './legs.js?v=b750';
import { drawDays } from './tripview.js?v=b750';
