...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b615';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b615';
import { drawCats } from './planline.js?v=b615';
import { drawPlanMap } from './planmap.js?v=b615';
import { drawPlans, openPlans } from './planview.js?v=b615';
import { STAY_MIN, mins } from './plancheck.js?v=b615';
import { hhmm } from './cands.js?v=b615';
import { legFor } from './legs.js?v=b615';
import { drawDays } from './tripview.js?v=b615';
