...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b485';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b485';
import { drawCats } from './planline.js?v=b485';
import { drawPlanMap } from './planmap.js?v=b485';
import { drawPlans, openPlans } from './planview.js?v=b485';
import { STAY_MIN, mins } from './plancheck.js?v=b485';
import { hhmm } from './cands.js?v=b485';
import { legFor } from './legs.js?v=b485';
import { drawDays } from './tripview.js?v=b485';
