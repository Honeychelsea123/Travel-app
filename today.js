...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b544';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b544';
import { drawCats } from './planline.js?v=b544';
import { drawPlanMap } from './planmap.js?v=b544';
import { drawPlans, openPlans } from './planview.js?v=b544';
import { STAY_MIN, mins } from './plancheck.js?v=b544';
import { hhmm } from './cands.js?v=b544';
import { legFor } from './legs.js?v=b544';
import { drawDays } from './tripview.js?v=b544';
