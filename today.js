...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b715';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b715';
import { drawCats } from './planline.js?v=b715';
import { drawPlanMap } from './planmap.js?v=b715';
import { drawPlans, openPlans } from './planview.js?v=b715';
import { STAY_MIN, mins } from './plancheck.js?v=b715';
import { hhmm } from './cands.js?v=b715';
import { legFor } from './legs.js?v=b715';
import { drawDays } from './tripview.js?v=b715';
