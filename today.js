...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b596';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b596';
import { drawCats } from './planline.js?v=b596';
import { drawPlanMap } from './planmap.js?v=b596';
import { drawPlans, openPlans } from './planview.js?v=b596';
import { STAY_MIN, mins } from './plancheck.js?v=b596';
import { hhmm } from './cands.js?v=b596';
import { legFor } from './legs.js?v=b596';
import { drawDays } from './tripview.js?v=b596';
