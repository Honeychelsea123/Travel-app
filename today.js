...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b520';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b520';
import { drawCats } from './planline.js?v=b520';
import { drawPlanMap } from './planmap.js?v=b520';
import { drawPlans, openPlans } from './planview.js?v=b520';
import { STAY_MIN, mins } from './plancheck.js?v=b520';
import { hhmm } from './cands.js?v=b520';
import { legFor } from './legs.js?v=b520';
import { drawDays } from './tripview.js?v=b520';
