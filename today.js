...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b424';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b424';
import { drawCats } from './planline.js?v=b424';
import { drawPlanMap } from './planmap.js?v=b424';
import { drawPlans, openPlans } from './planview.js?v=b424';
import { STAY_MIN, mins } from './plancheck.js?v=b424';
import { hhmm } from './cands.js?v=b424';
import { legFor } from './legs.js?v=b424';
import { drawDays } from './tripview.js?v=b424';
