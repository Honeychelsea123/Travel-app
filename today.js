...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b403';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b403';
import { drawCats } from './planline.js?v=b403';
import { drawPlanMap } from './planmap.js?v=b403';
import { drawPlans, openPlans } from './planview.js?v=b403';
import { STAY_MIN, mins } from './plancheck.js?v=b403';
import { hhmm } from './cands.js?v=b403';
import { legFor } from './legs.js?v=b403';
import { drawDays } from './tripview.js?v=b403';
