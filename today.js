...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b406';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b406';
import { drawCats } from './planline.js?v=b406';
import { drawPlanMap } from './planmap.js?v=b406';
import { drawPlans, openPlans } from './planview.js?v=b406';
import { STAY_MIN, mins } from './plancheck.js?v=b406';
import { hhmm } from './cands.js?v=b406';
import { legFor } from './legs.js?v=b406';
import { drawDays } from './tripview.js?v=b406';
