...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b456';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b456';
import { drawCats } from './planline.js?v=b456';
import { drawPlanMap } from './planmap.js?v=b456';
import { drawPlans, openPlans } from './planview.js?v=b456';
import { STAY_MIN, mins } from './plancheck.js?v=b456';
import { hhmm } from './cands.js?v=b456';
import { legFor } from './legs.js?v=b456';
import { drawDays } from './tripview.js?v=b456';
