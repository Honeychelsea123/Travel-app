...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b443';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b443';
import { drawCats } from './planline.js?v=b443';
import { drawPlanMap } from './planmap.js?v=b443';
import { drawPlans, openPlans } from './planview.js?v=b443';
import { STAY_MIN, mins } from './plancheck.js?v=b443';
import { hhmm } from './cands.js?v=b443';
import { legFor } from './legs.js?v=b443';
import { drawDays } from './tripview.js?v=b443';
