...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b697';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b697';
import { drawCats } from './planline.js?v=b697';
import { drawPlanMap } from './planmap.js?v=b697';
import { drawPlans, openPlans } from './planview.js?v=b697';
import { STAY_MIN, mins } from './plancheck.js?v=b697';
import { hhmm } from './cands.js?v=b697';
import { legFor } from './legs.js?v=b697';
import { drawDays } from './tripview.js?v=b697';
