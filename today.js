...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b426';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b426';
import { drawCats } from './planline.js?v=b426';
import { drawPlanMap } from './planmap.js?v=b426';
import { drawPlans, openPlans } from './planview.js?v=b426';
import { STAY_MIN, mins } from './plancheck.js?v=b426';
import { hhmm } from './cands.js?v=b426';
import { legFor } from './legs.js?v=b426';
import { drawDays } from './tripview.js?v=b426';
