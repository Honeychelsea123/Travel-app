...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b450';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b450';
import { drawCats } from './planline.js?v=b450';
import { drawPlanMap } from './planmap.js?v=b450';
import { drawPlans, openPlans } from './planview.js?v=b450';
import { STAY_MIN, mins } from './plancheck.js?v=b450';
import { hhmm } from './cands.js?v=b450';
import { legFor } from './legs.js?v=b450';
import { drawDays } from './tripview.js?v=b450';
