...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b488';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b488';
import { drawCats } from './planline.js?v=b488';
import { drawPlanMap } from './planmap.js?v=b488';
import { drawPlans, openPlans } from './planview.js?v=b488';
import { STAY_MIN, mins } from './plancheck.js?v=b488';
import { hhmm } from './cands.js?v=b488';
import { legFor } from './legs.js?v=b488';
import { drawDays } from './tripview.js?v=b488';
