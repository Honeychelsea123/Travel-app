...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b644';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b644';
import { drawCats } from './planline.js?v=b644';
import { drawPlanMap } from './planmap.js?v=b644';
import { drawPlans, openPlans } from './planview.js?v=b644';
import { STAY_MIN, mins } from './plancheck.js?v=b644';
import { hhmm } from './cands.js?v=b644';
import { legFor } from './legs.js?v=b644';
import { drawDays } from './tripview.js?v=b644';
