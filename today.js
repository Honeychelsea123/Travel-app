...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b499';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b499';
import { drawCats } from './planline.js?v=b499';
import { drawPlanMap } from './planmap.js?v=b499';
import { drawPlans, openPlans } from './planview.js?v=b499';
import { STAY_MIN, mins } from './plancheck.js?v=b499';
import { hhmm } from './cands.js?v=b499';
import { legFor } from './legs.js?v=b499';
import { drawDays } from './tripview.js?v=b499';
