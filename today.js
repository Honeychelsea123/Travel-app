...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b599';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b599';
import { drawCats } from './planline.js?v=b599';
import { drawPlanMap } from './planmap.js?v=b599';
import { drawPlans, openPlans } from './planview.js?v=b599';
import { STAY_MIN, mins } from './plancheck.js?v=b599';
import { hhmm } from './cands.js?v=b599';
import { legFor } from './legs.js?v=b599';
import { drawDays } from './tripview.js?v=b599';
