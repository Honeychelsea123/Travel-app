...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b537';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b537';
import { drawCats } from './planline.js?v=b537';
import { drawPlanMap } from './planmap.js?v=b537';
import { drawPlans, openPlans } from './planview.js?v=b537';
import { STAY_MIN, mins } from './plancheck.js?v=b537';
import { hhmm } from './cands.js?v=b537';
import { legFor } from './legs.js?v=b537';
import { drawDays } from './tripview.js?v=b537';
