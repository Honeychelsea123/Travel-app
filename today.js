...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b592';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b592';
import { drawCats } from './planline.js?v=b592';
import { drawPlanMap } from './planmap.js?v=b592';
import { drawPlans, openPlans } from './planview.js?v=b592';
import { STAY_MIN, mins } from './plancheck.js?v=b592';
import { hhmm } from './cands.js?v=b592';
import { legFor } from './legs.js?v=b592';
import { drawDays } from './tripview.js?v=b592';
