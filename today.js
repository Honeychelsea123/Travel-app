...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b540';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b540';
import { drawCats } from './planline.js?v=b540';
import { drawPlanMap } from './planmap.js?v=b540';
import { drawPlans, openPlans } from './planview.js?v=b540';
import { STAY_MIN, mins } from './plancheck.js?v=b540';
import { hhmm } from './cands.js?v=b540';
import { legFor } from './legs.js?v=b540';
import { drawDays } from './tripview.js?v=b540';
