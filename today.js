...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b630';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b630';
import { drawCats } from './planline.js?v=b630';
import { drawPlanMap } from './planmap.js?v=b630';
import { drawPlans, openPlans } from './planview.js?v=b630';
import { STAY_MIN, mins } from './plancheck.js?v=b630';
import { hhmm } from './cands.js?v=b630';
import { legFor } from './legs.js?v=b630';
import { drawDays } from './tripview.js?v=b630';
