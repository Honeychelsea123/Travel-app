...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b701';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b701';
import { drawCats } from './planline.js?v=b701';
import { drawPlanMap } from './planmap.js?v=b701';
import { drawPlans, openPlans } from './planview.js?v=b701';
import { STAY_MIN, mins } from './plancheck.js?v=b701';
import { hhmm } from './cands.js?v=b701';
import { legFor } from './legs.js?v=b701';
import { drawDays } from './tripview.js?v=b701';
