...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b416';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b416';
import { drawCats } from './planline.js?v=b416';
import { drawPlanMap } from './planmap.js?v=b416';
import { drawPlans, openPlans } from './planview.js?v=b416';
import { STAY_MIN, mins } from './plancheck.js?v=b416';
import { hhmm } from './cands.js?v=b416';
import { legFor } from './legs.js?v=b416';
import { drawDays } from './tripview.js?v=b416';
