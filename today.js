...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b626';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b626';
import { drawCats } from './planline.js?v=b626';
import { drawPlanMap } from './planmap.js?v=b626';
import { drawPlans, openPlans } from './planview.js?v=b626';
import { STAY_MIN, mins } from './plancheck.js?v=b626';
import { hhmm } from './cands.js?v=b626';
import { legFor } from './legs.js?v=b626';
import { drawDays } from './tripview.js?v=b626';
