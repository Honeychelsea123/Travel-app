...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b731';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b731';
import { drawCats } from './planline.js?v=b731';
import { drawPlanMap } from './planmap.js?v=b731';
import { drawPlans, openPlans } from './planview.js?v=b731';
import { STAY_MIN, mins } from './plancheck.js?v=b731';
import { hhmm } from './cands.js?v=b731';
import { legFor } from './legs.js?v=b731';
import { drawDays } from './tripview.js?v=b731';
