...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b636';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b636';
import { drawCats } from './planline.js?v=b636';
import { drawPlanMap } from './planmap.js?v=b636';
import { drawPlans, openPlans } from './planview.js?v=b636';
import { STAY_MIN, mins } from './plancheck.js?v=b636';
import { hhmm } from './cands.js?v=b636';
import { legFor } from './legs.js?v=b636';
import { drawDays } from './tripview.js?v=b636';
