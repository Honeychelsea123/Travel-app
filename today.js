...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b565';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b565';
import { drawCats } from './planline.js?v=b565';
import { drawPlanMap } from './planmap.js?v=b565';
import { drawPlans, openPlans } from './planview.js?v=b565';
import { STAY_MIN, mins } from './plancheck.js?v=b565';
import { hhmm } from './cands.js?v=b565';
import { legFor } from './legs.js?v=b565';
import { drawDays } from './tripview.js?v=b565';
