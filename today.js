...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b650';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b650';
import { drawCats } from './planline.js?v=b650';
import { drawPlanMap } from './planmap.js?v=b650';
import { drawPlans, openPlans } from './planview.js?v=b650';
import { STAY_MIN, mins } from './plancheck.js?v=b650';
import { hhmm } from './cands.js?v=b650';
import { legFor } from './legs.js?v=b650';
import { drawDays } from './tripview.js?v=b650';
