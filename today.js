...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b415';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b415';
import { drawCats } from './planline.js?v=b415';
import { drawPlanMap } from './planmap.js?v=b415';
import { drawPlans, openPlans } from './planview.js?v=b415';
import { STAY_MIN, mins } from './plancheck.js?v=b415';
import { hhmm } from './cands.js?v=b415';
import { legFor } from './legs.js?v=b415';
import { drawDays } from './tripview.js?v=b415';
