...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b624';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b624';
import { drawCats } from './planline.js?v=b624';
import { drawPlanMap } from './planmap.js?v=b624';
import { drawPlans, openPlans } from './planview.js?v=b624';
import { STAY_MIN, mins } from './plancheck.js?v=b624';
import { hhmm } from './cands.js?v=b624';
import { legFor } from './legs.js?v=b624';
import { drawDays } from './tripview.js?v=b624';
