...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b486';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b486';
import { drawCats } from './planline.js?v=b486';
import { drawPlanMap } from './planmap.js?v=b486';
import { drawPlans, openPlans } from './planview.js?v=b486';
import { STAY_MIN, mins } from './plancheck.js?v=b486';
import { hhmm } from './cands.js?v=b486';
import { legFor } from './legs.js?v=b486';
import { drawDays } from './tripview.js?v=b486';
