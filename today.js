...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b730';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b730';
import { drawCats } from './planline.js?v=b730';
import { drawPlanMap } from './planmap.js?v=b730';
import { drawPlans, openPlans } from './planview.js?v=b730';
import { STAY_MIN, mins } from './plancheck.js?v=b730';
import { hhmm } from './cands.js?v=b730';
import { legFor } from './legs.js?v=b730';
import { drawDays } from './tripview.js?v=b730';
