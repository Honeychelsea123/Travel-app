...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b702';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b702';
import { drawCats } from './planline.js?v=b702';
import { drawPlanMap } from './planmap.js?v=b702';
import { drawPlans, openPlans } from './planview.js?v=b702';
import { STAY_MIN, mins } from './plancheck.js?v=b702';
import { hhmm } from './cands.js?v=b702';
import { legFor } from './legs.js?v=b702';
import { drawDays } from './tripview.js?v=b702';
