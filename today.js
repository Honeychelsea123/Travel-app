...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b586';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b586';
import { drawCats } from './planline.js?v=b586';
import { drawPlanMap } from './planmap.js?v=b586';
import { drawPlans, openPlans } from './planview.js?v=b586';
import { STAY_MIN, mins } from './plancheck.js?v=b586';
import { hhmm } from './cands.js?v=b586';
import { legFor } from './legs.js?v=b586';
import { drawDays } from './tripview.js?v=b586';
