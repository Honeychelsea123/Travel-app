...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b417';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b417';
import { drawCats } from './planline.js?v=b417';
import { drawPlanMap } from './planmap.js?v=b417';
import { drawPlans, openPlans } from './planview.js?v=b417';
import { STAY_MIN, mins } from './plancheck.js?v=b417';
import { hhmm } from './cands.js?v=b417';
import { legFor } from './legs.js?v=b417';
import { drawDays } from './tripview.js?v=b417';
