...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b360';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b360';
import { drawCats } from './planline.js?v=b360';
import { drawPlanMap } from './planmap.js?v=b360';
import { drawPlans, openPlans } from './planview.js?v=b360';
import { STAY_MIN, mins } from './plancheck.js?v=b360';
import { hhmm } from './cands.js?v=b360';
import { legFor } from './legs.js?v=b360';
import { drawDays } from './tripview.js?v=b360';
