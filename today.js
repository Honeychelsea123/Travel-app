...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b600';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b600';
import { drawCats } from './planline.js?v=b600';
import { drawPlanMap } from './planmap.js?v=b600';
import { drawPlans, openPlans } from './planview.js?v=b600';
import { STAY_MIN, mins } from './plancheck.js?v=b600';
import { hhmm } from './cands.js?v=b600';
import { legFor } from './legs.js?v=b600';
import { drawDays } from './tripview.js?v=b600';
