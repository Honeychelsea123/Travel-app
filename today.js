...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b729';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b729';
import { drawCats } from './planline.js?v=b729';
import { drawPlanMap } from './planmap.js?v=b729';
import { drawPlans, openPlans } from './planview.js?v=b729';
import { STAY_MIN, mins } from './plancheck.js?v=b729';
import { hhmm } from './cands.js?v=b729';
import { legFor } from './legs.js?v=b729';
import { drawDays } from './tripview.js?v=b729';
