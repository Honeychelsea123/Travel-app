...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b686';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b686';
import { drawCats } from './planline.js?v=b686';
import { drawPlanMap } from './planmap.js?v=b686';
import { drawPlans, openPlans } from './planview.js?v=b686';
import { STAY_MIN, mins } from './plancheck.js?v=b686';
import { hhmm } from './cands.js?v=b686';
import { legFor } from './legs.js?v=b686';
import { drawDays } from './tripview.js?v=b686';
