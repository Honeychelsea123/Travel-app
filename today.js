...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b747';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b747';
import { drawCats } from './planline.js?v=b747';
import { drawPlanMap } from './planmap.js?v=b747';
import { drawPlans, openPlans } from './planview.js?v=b747';
import { STAY_MIN, mins } from './plancheck.js?v=b747';
import { hhmm } from './cands.js?v=b747';
import { legFor } from './legs.js?v=b747';
import { drawDays } from './tripview.js?v=b747';
