...
import { D1, asDate, hm, hop, todayYmd } from './calc.js?v=b560';
import { trip, plans, legs, setPickedDay, setTodayOn } from './trip.js?v=b560';
import { drawCats } from './planline.js?v=b560';
import { drawPlanMap } from './planmap.js?v=b560';
import { drawPlans, openPlans } from './planview.js?v=b560';
import { STAY_MIN, mins } from './plancheck.js?v=b560';
import { hhmm } from './cands.js?v=b560';
import { legFor } from './legs.js?v=b560';
import { drawDays } from './tripview.js?v=b560';
