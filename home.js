...
import { fail, netTimeout, netIsDown, drawOffbar } from './net.js?v=b474';
import { hm, todayYmd } from './calc.js?v=b474';
...
import { cities, countryName } from './cities.js?v=b474';
import { myRates, visited } from './rate.js?v=b474';
import { plans } from './trip.js?v=b474';
import { openCity } from './city.js?v=b474';
import { loadCities, pick } from './citysearch.js?v=b474';
import { saveRate, dropRate, refreshVisited } from './rating.js?v=b474';
/* CONT 는 대륙별 분모(b451) — 지도 화면과 **같은 표**를 씁니다.
   여기서 새로 적으면 두 화면의 분모가 갈라집니다. */
import { openMap, UN_COUNTRIES, CONT, mapBackTo } from './map.js?v=b474';
...
import { drawReport } from './report.js?v=b474';
...
import { PERSONA_BG } from './card.js?v=b474';
import { openNew } from './newtrip.js?v=b474';
