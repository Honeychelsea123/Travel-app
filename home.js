...
import { fail, netTimeout, netIsDown, drawOffbar } from './net.js?v=b727';
import { hm, todayYmd } from './calc.js?v=b727';
import { starHtml, paintStars } from './stars.js?v=b727';
/* 평가 히어로는 세 화면이 같은 것을 씁니다 — rateui.js 머리말 참고(b409). */
import { starValue } from './rateui.js?v=b727';
import { cities, countryName, cityCountry } from './cities.js?v=b727';
import { UN_CODES } from './un.js?v=b727';
import { myRates, cityStat, visited } from './rate.js?v=b727';
import { plans } from './trip.js?v=b727';
import { loadCities } from './citysearch.js?v=b727';
/* 지구본에서 나라를 누르면 뜨는 카드가 도시 화면으로 보냅니다(b555). */
import { openCity } from './city.js?v=b727';
import { saveRate, refreshVisited, loadRateData } from './rating.js?v=b727';
/* CONT 는 대륙별 분모(b451) — 지도 화면과 **같은 표**를 씁니다.
   여기서 새로 적으면 두 화면의 분모가 갈라집니다. */
import { openMap, UN_COUNTRIES, CONT, CONT_VIEW, mapBackTo } from './map.js?v=b727';
...
import { drawReport } from './report.js?v=b727';
