...
import { fail, netTimeout, netIsDown, drawOffbar } from './net.js?v=b465';
import { hm, todayYmd } from './calc.js?v=b465';
import { starHtml, paintStars, markRated } from './stars.js?v=b465';
/* 평가 히어로는 세 화면이 같은 것을 씁니다 — rateui.js 머리말 참고(b409). */
import { rateHero, starValue } from './rateui.js?v=b465';
import { cities, countryName } from './cities.js?v=b465';
import { myRates, visited } from './rate.js?v=b465';
import { plans } from './trip.js?v=b465';
import { openCity } from './city.js?v=b465';
import { loadCities, pick } from './citysearch.js?v=b465';
import { saveRate, dropRate, refreshVisited } from './rating.js?v=b465';
/* CONT 는 대륙별 분모(b451) — 지도 화면과 **같은 표**를 씁니다.
   여기서 새로 적으면 두 화면의 분모가 갈라집니다. */
import { openMap, UN_COUNTRIES, CONT, mapBackTo } from './map.js?v=b465';
...
import { drawReport } from './report.js?v=b465';
...
import { PERSONA_BG } from './card.js?v=b465';
