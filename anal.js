...
import { cityStat } from './rate.js?v=b669';
/* `cityStat` 이 비어 있을 때 한 번 싣습니다. ⚠ rate.js·rating.js 는
   anal.js 를 모르므로 고리가 안 생깁니다(확인함). */
import { loadRateData } from './rating.js?v=b669';
...
import { renderPersona } from './persona.js?v=b669';
...
/* 추천과 궁합은 성향 리포트에서 꺼내온 것입니다(b461) — 계산은 원래
   ...
   다른 답을 내놓습니다. */
import { similarPicks } from './rec.js?v=b669';
/* 여행 만들기로 바로 잇습니다(b463) — newtrip.js 는 anal.js 를 모르므로
   고리가 안 생깁니다(확인함). */
import { openNew } from './newtrip.js?v=b669';
import { pickCity } from './citysearch.js?v=b669';
