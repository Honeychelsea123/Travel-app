...
import { cities, continentOf } from './cities.js?v=b480';
/* personaBackTo 는 persona.js 것입니다 — 「분석에서 왔다」를 적어두면
   닫을 때 분석 탭으로 돌아옵니다(b453). */
import { personaBackTo } from './persona.js?v=b480';
import { personaAxes, personaRank, personaMates, PERSONA16, AXIS_WORD,
         AXIS_NAME } from './card.js?v=b480';
import { UN_COUNTRIES, CONT, mapBackTo, funRows } from './map.js?v=b480';
...
import { pickCity } from './citysearch.js?v=b480';
import { shareMate } from './mate.js?v=b480';
...
export async function loadAnal(){
  ...
  if (매긴것.length >= 문턱){
    ...
    머리.innerHTML = `<div class="pmeta"><div class="pcode">${esc(ax.code)}</div>
      ...
      <div class="part"><img src="./persona/${esc(ax.code)}.png?v=b480"
