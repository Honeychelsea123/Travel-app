...
import { cityStat } from './rate.js?v=b698';
/* `cityStat` 이 비어 있을 때 한 번 싣습니다. ⚠ rate.js·rating.js 는
   anal.js 를 모르므로 고리가 안 생깁니다(확인함). */
import { loadRateData } from './rating.js?v=b698';
...
import { renderPersona } from './persona.js?v=b698';
...
/* 여행 만들기로 바로 잇습니다(b463) — newtrip.js 는 anal.js 를 모르므로
   고리가 안 생깁니다(확인함). */
import { openNew } from './newtrip.js?v=b698';
import { pickCity } from './citysearch.js?v=b698';
