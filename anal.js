...
import { renderPersona } from './persona.js?v=b751';
...
/* 여행 만들기로 바로 잇습니다(b463) — newtrip.js 는 anal.js 를 모르므로
   고리가 안 생깁니다(확인함). */
import { openNew } from './newtrip.js?v=b751';
import { pickCity } from './citysearch.js?v=b751';
